...
class APISecretsApi
{
     ...
     */
    public function projectSecretCreate($project_secret_create_req = null)
    {
        list($response) = $this->projectSecretCreateWithHttpInfo($project_secret_create_req);
        return $response;
    }
     ...
     */
    public function projectSecretCreateWithHttpInfo($project_secret_create_req = null)
    {
        $request = $this->projectSecretCreateRequest($project_secret_create_req);
     ...
     */
    public function projectSecretCreateAsync($project_secret_create_req = null)
    {
        return $this->projectSecretCreateAsyncWithHttpInfo($project_secret_create_req)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function projectSecretCreateAsyncWithHttpInfo($project_secret_create_req = null)
    {
        $returnType = '\Corbado\Generated\Model\ProjectSecretCreateRsp';
        $request = $this->projectSecretCreateRequest($project_secret_create_req);
     ...
     */
    public function projectSecretCreateRequest($project_secret_create_req = null)
    {
        ...
        if (isset($project_secret_create_req)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($project_secret_create_req));
            } else {
     ...
     */
    public function projectSecretDelete($secret_id, $project_secret_delete_req = null)
    {
        list($response) = $this->projectSecretDeleteWithHttpInfo($secret_id, $project_secret_delete_req);
        return $response;
    }
     ...
     */
    public function projectSecretDeleteWithHttpInfo($secret_id, $project_secret_delete_req = null)
    {
        $request = $this->projectSecretDeleteRequest($secret_id, $project_secret_delete_req);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function projectSecretDeleteAsync($secret_id, $project_secret_delete_req = null)
    {
        return $this->projectSecretDeleteAsyncWithHttpInfo($secret_id, $project_secret_delete_req)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function projectSecretDeleteAsyncWithHttpInfo($secret_id, $project_secret_delete_req = null)
    {
        $returnType = '\Corbado\Generated\Model\GenericRsp';
        $request = $this->projectSecretDeleteRequest($secret_id, $project_secret_delete_req);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function projectSecretDeleteRequest($secret_id, $project_secret_delete_req = null)
    {
        ...
        if (isset($project_secret_delete_req)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($project_secret_delete_req));
            } else {
     ...
     */
    public function projectSecretList()
    {
        list($response) = $this->projectSecretListWithHttpInfo();
        return $response;
    }
     ...
     */
    public function projectSecretListWithHttpInfo()
    {
        $request = $this->projectSecretListRequest();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function projectSecretListAsync()
    {
        return $this->projectSecretListAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function projectSecretListAsyncWithHttpInfo()
    {
        $returnType = '\Corbado\Generated\Model\ProjectSecretListRsp';
        $request = $this->projectSecretListRequest();
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function projectSecretListRequest()
    {
