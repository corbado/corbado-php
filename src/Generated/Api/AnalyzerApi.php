...
class AnalyzerApi
{
    ...
    {
        list($response) = $this->trackingAllRequestWithHttpInfo($remote_address, $user_agent, $sort, $filter, $page, $page_size, $contentType);
        return $response;
    }
     ...
     */
    public function trackingAllRequestAsync($remote_address = null, $user_agent = null, $sort = null, $filter = null, $page = 1, $page_size = 10, string $contentType = self::contentTypes['trackingAllRequest'][0])
    {
        return $this->trackingAllRequestAsyncWithHttpInfo($remote_address, $user_agent, $sort, $filter, $page, $page_size, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function trackingAllRequestRequest($remote_address = null, $user_agent = null, $sort = null, $filter = null, $page = 1, $page_size = 10, string $contentType = self::contentTypes['trackingAllRequest'][0])
    {
    ...
    /**
     * Operation trackingBackupStateGet
     *
     * @param  string $remote_address Client&#39;s remote address (optional)
     * @param  string $user_agent Client&#39;s user agent (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['trackingBackupStateGet'] to see the possible values for this operation
     *
     * @throws \Corbado\Generated\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Corbado\Generated\Model\TrackingBackupStateGetRsp
     */
    public function trackingBackupStateGet($remote_address = null, $user_agent = null, string $contentType = self::contentTypes['trackingBackupStateGet'][0])
    {
        list($response) = $this->trackingBackupStateGetWithHttpInfo($remote_address, $user_agent, $contentType);
        return $response;
    }

    /**
     * Operation trackingBackupStateGetWithHttpInfo
     *
     * @param  string $remote_address Client&#39;s remote address (optional)
     * @param  string $user_agent Client&#39;s user agent (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['trackingBackupStateGet'] to see the possible values for this operation
     ...
     * @throws \Corbado\Generated\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Corbado\Generated\Model\TrackingBackupStateGetRsp, HTTP status code, HTTP response headers (array of strings)
     */
    public function trackingBackupStateGetWithHttpInfo($remote_address = null, $user_agent = null, string $contentType = self::contentTypes['trackingBackupStateGet'][0])
    {
        $request = $this->trackingBackupStateGetRequest($remote_address, $user_agent, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Corbado\Generated\Model\TrackingBackupStateGetRsp' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Corbado\Generated\Model\TrackingBackupStateGetRsp' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Corbado\Generated\Model\TrackingBackupStateGetRsp', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Corbado\Generated\Model\TrackingBackupStateGetRsp';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Corbado\Generated\Model\TrackingBackupStateGetRsp',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation trackingBackupStateGetAsync
     *
     * @param  string $remote_address Client&#39;s remote address (optional)
     * @param  string $user_agent Client&#39;s user agent (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['trackingBackupStateGet'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function trackingBackupStateGetAsync($remote_address = null, $user_agent = null, string $contentType = self::contentTypes['trackingBackupStateGet'][0])
    {
        return $this->trackingBackupStateGetAsyncWithHttpInfo($remote_address, $user_agent, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation trackingBackupStateGetAsyncWithHttpInfo
     *
     * @param  string $remote_address Client&#39;s remote address (optional)
     * @param  string $user_agent Client&#39;s user agent (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['trackingBackupStateGet'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function trackingBackupStateGetAsyncWithHttpInfo($remote_address = null, $user_agent = null, string $contentType = self::contentTypes['trackingBackupStateGet'][0])
    {
        $returnType = '\Corbado\Generated\Model\TrackingBackupStateGetRsp';
        $request = $this->trackingBackupStateGetRequest($remote_address, $user_agent, $contentType);
    ...
    /**
     * Create request for operation 'trackingBackupStateGet'
     *
     * @param  string $remote_address Client&#39;s remote address (optional)
     * @param  string $user_agent Client&#39;s user agent (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['trackingBackupStateGet'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function trackingBackupStateGetRequest($remote_address = null, $user_agent = null, string $contentType = self::contentTypes['trackingBackupStateGet'][0])
    {




        $resourcePath = '/v1/tracking/backupState';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->trackingBrowserDetailedStatsListWithHttpInfo($granularity, $remote_address, $user_agent, $sort, $filter, $page, $page_size, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function trackingBrowserDetailedStatsListAsync($granularity, $remote_address = null, $user_agent = null, $sort = null, $filter = null, $page = 1, $page_size = 10, string $contentType = self::contentTypes['trackingBrowserDetailedStatsList'][0])
    {
        return $this->trackingBrowserDetailedStatsListAsyncWithHttpInfo($granularity, $remote_address, $user_agent, $sort, $filter, $page, $page_size, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function trackingBrowserDetailedStatsListRequest($granularity, $remote_address = null, $user_agent = null, $sort = null, $filter = null, $page = 1, $page_size = 10, string $contentType = self::contentTypes['trackingBrowserDetailedStatsList'][0])
    {
    ...
    {
        list($response) = $this->trackingBrowserStatsListWithHttpInfo($granularity, $remote_address, $user_agent, $sort, $filter, $page, $page_size, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function trackingBrowserStatsListAsync($granularity, $remote_address = null, $user_agent = null, $sort = null, $filter = null, $page = 1, $page_size = 10, string $contentType = self::contentTypes['trackingBrowserStatsList'][0])
    {
        return $this->trackingBrowserStatsListAsyncWithHttpInfo($granularity, $remote_address, $user_agent, $sort, $filter, $page, $page_size, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function trackingBrowserStatsListRequest($granularity, $remote_address = null, $user_agent = null, $sort = null, $filter = null, $page = 1, $page_size = 10, string $contentType = self::contentTypes['trackingBrowserStatsList'][0])
    {
    ...
    /**
     * Operation trackingDetailedStatsList
     *
     * @param  string $granularity Data granularity (required)
     * @param  string $remote_address Client&#39;s remote address (optional)
     * @param  string $user_agent Client&#39;s user agent (optional)
     ...
     * @param  int $page Page number (optional, default to 1)
     * @param  int $page_size Number of items per page (optional, default to 10)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['trackingDetailedStatsList'] to see the possible values for this operation
     *
     * @throws \Corbado\Generated\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Corbado\Generated\Model\TrackingDetailedStatsListRsp
     */
    public function trackingDetailedStatsList($granularity, $remote_address = null, $user_agent = null, $sort = null, $filter = null, $page = 1, $page_size = 10, string $contentType = self::contentTypes['trackingDetailedStatsList'][0])
    {
        list($response) = $this->trackingDetailedStatsListWithHttpInfo($granularity, $remote_address, $user_agent, $sort, $filter, $page, $page_size, $contentType);
        return $response;
    }

    /**
     * Operation trackingDetailedStatsListWithHttpInfo
     *
     * @param  string $granularity Data granularity (required)
     * @param  string $remote_address Client&#39;s remote address (optional)
     * @param  string $user_agent Client&#39;s user agent (optional)
     ...
     * @throws \Corbado\Generated\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Corbado\Generated\Model\TrackingDetailedStatsListRsp, HTTP status code, HTTP response headers (array of strings)
     */
    public function trackingDetailedStatsListWithHttpInfo($granularity, $remote_address = null, $user_agent = null, $sort = null, $filter = null, $page = 1, $page_size = 10, string $contentType = self::contentTypes['trackingDetailedStatsList'][0])
    {
        $request = $this->trackingDetailedStatsListRequest($granularity, $remote_address, $user_agent, $sort, $filter, $page, $page_size, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Corbado\Generated\Model\TrackingDetailedStatsListRsp' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Corbado\Generated\Model\TrackingDetailedStatsListRsp' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Corbado\Generated\Model\TrackingDetailedStatsListRsp', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Corbado\Generated\Model\TrackingDetailedStatsListRsp';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Corbado\Generated\Model\TrackingDetailedStatsListRsp',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation trackingDetailedStatsListAsync
     *
     * @param  string $granularity Data granularity (required)
     * @param  string $remote_address Client&#39;s remote address (optional)
     * @param  string $user_agent Client&#39;s user agent (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function trackingDetailedStatsListAsync($granularity, $remote_address = null, $user_agent = null, $sort = null, $filter = null, $page = 1, $page_size = 10, string $contentType = self::contentTypes['trackingDetailedStatsList'][0])
    {
        return $this->trackingDetailedStatsListAsyncWithHttpInfo($granularity, $remote_address, $user_agent, $sort, $filter, $page, $page_size, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function trackingDetailedStatsListAsyncWithHttpInfo($granularity, $remote_address = null, $user_agent = null, $sort = null, $filter = null, $page = 1, $page_size = 10, string $contentType = self::contentTypes['trackingDetailedStatsList'][0])
    {
        $returnType = '\Corbado\Generated\Model\TrackingDetailedStatsListRsp';
        $request = $this->trackingDetailedStatsListRequest($granularity, $remote_address, $user_agent, $sort, $filter, $page, $page_size, $contentType);
    ...
    /**
     * Create request for operation 'trackingDetailedStatsList'
     *
     * @param  string $granularity Data granularity (required)
     * @param  string $remote_address Client&#39;s remote address (optional)
     * @param  string $user_agent Client&#39;s user agent (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function trackingDetailedStatsListRequest($granularity, $remote_address = null, $user_agent = null, $sort = null, $filter = null, $page = 1, $page_size = 10, string $contentType = self::contentTypes['trackingDetailedStatsList'][0])
    {

        // verify the required parameter 'granularity' is set
        if ($granularity === null || (is_array($granularity) && count($granularity) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $granularity when calling trackingDetailedStatsList'
            );
        }
        ...
        $resourcePath = '/v1/tracking/stats/detailed';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation trackingEnumsGet
     *
     * @param  string $remote_address Client&#39;s remote address (optional)
     * @param  string $user_agent Client&#39;s user agent (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['trackingEnumsGet'] to see the possible values for this operation
     *
     * @throws \Corbado\Generated\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Corbado\Generated\Model\TrackingEnumsGetRsp
     */
    public function trackingEnumsGet($remote_address = null, $user_agent = null, string $contentType = self::contentTypes['trackingEnumsGet'][0])
    {
        list($response) = $this->trackingEnumsGetWithHttpInfo($remote_address, $user_agent, $contentType);
        return $response;
    }

    /**
     * Operation trackingEnumsGetWithHttpInfo
     *
     * @param  string $remote_address Client&#39;s remote address (optional)
     * @param  string $user_agent Client&#39;s user agent (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['trackingEnumsGet'] to see the possible values for this operation
     ...
     * @throws \Corbado\Generated\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Corbado\Generated\Model\TrackingEnumsGetRsp, HTTP status code, HTTP response headers (array of strings)
     */
    public function trackingEnumsGetWithHttpInfo($remote_address = null, $user_agent = null, string $contentType = self::contentTypes['trackingEnumsGet'][0])
    {
        $request = $this->trackingEnumsGetRequest($remote_address, $user_agent, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Corbado\Generated\Model\TrackingEnumsGetRsp' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Corbado\Generated\Model\TrackingEnumsGetRsp' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Corbado\Generated\Model\TrackingEnumsGetRsp', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Corbado\Generated\Model\TrackingEnumsGetRsp';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Corbado\Generated\Model\TrackingEnumsGetRsp',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation trackingEnumsGetAsync
     *
     * @param  string $remote_address Client&#39;s remote address (optional)
     * @param  string $user_agent Client&#39;s user agent (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['trackingEnumsGet'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function trackingEnumsGetAsync($remote_address = null, $user_agent = null, string $contentType = self::contentTypes['trackingEnumsGet'][0])
    {
        return $this->trackingEnumsGetAsyncWithHttpInfo($remote_address, $user_agent, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation trackingEnumsGetAsyncWithHttpInfo
     *
     * @param  string $remote_address Client&#39;s remote address (optional)
     * @param  string $user_agent Client&#39;s user agent (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['trackingEnumsGet'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function trackingEnumsGetAsyncWithHttpInfo($remote_address = null, $user_agent = null, string $contentType = self::contentTypes['trackingEnumsGet'][0])
    {
        $returnType = '\Corbado\Generated\Model\TrackingEnumsGetRsp';
        $request = $this->trackingEnumsGetRequest($remote_address, $user_agent, $contentType);
    ...
    /**
     * Create request for operation 'trackingEnumsGet'
     *
     * @param  string $remote_address Client&#39;s remote address (optional)
     * @param  string $user_agent Client&#39;s user agent (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['trackingEnumsGet'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function trackingEnumsGetRequest($remote_address = null, $user_agent = null, string $contentType = self::contentTypes['trackingEnumsGet'][0])
    {




        $resourcePath = '/v1/tracking/enums';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->trackingOSDetailedStatsListWithHttpInfo($granularity, $remote_address, $user_agent, $sort, $filter, $page, $page_size, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function trackingOSDetailedStatsListAsync($granularity, $remote_address = null, $user_agent = null, $sort = null, $filter = null, $page = 1, $page_size = 10, string $contentType = self::contentTypes['trackingOSDetailedStatsList'][0])
    {
        return $this->trackingOSDetailedStatsListAsyncWithHttpInfo($granularity, $remote_address, $user_agent, $sort, $filter, $page, $page_size, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function trackingOSDetailedStatsListRequest($granularity, $remote_address = null, $user_agent = null, $sort = null, $filter = null, $page = 1, $page_size = 10, string $contentType = self::contentTypes['trackingOSDetailedStatsList'][0])
    {
    ...
    {
        list($response) = $this->trackingOSStatsListWithHttpInfo($granularity, $remote_address, $user_agent, $sort, $filter, $page, $page_size, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function trackingOSStatsListAsync($granularity, $remote_address = null, $user_agent = null, $sort = null, $filter = null, $page = 1, $page_size = 10, string $contentType = self::contentTypes['trackingOSStatsList'][0])
    {
        return $this->trackingOSStatsListAsyncWithHttpInfo($granularity, $remote_address, $user_agent, $sort, $filter, $page, $page_size, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function trackingOSStatsListRequest($granularity, $remote_address = null, $user_agent = null, $sort = null, $filter = null, $page = 1, $page_size = 10, string $contentType = self::contentTypes['trackingOSStatsList'][0])
    {
    ...
    {
        list($response) = $this->trackingStatsListWithHttpInfo($granularity, $remote_address, $user_agent, $sort, $filter, $page, $page_size, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function trackingStatsListAsync($granularity, $remote_address = null, $user_agent = null, $sort = null, $filter = null, $page = 1, $page_size = 10, string $contentType = self::contentTypes['trackingStatsList'][0])
    {
        return $this->trackingStatsListAsyncWithHttpInfo($granularity, $remote_address, $user_agent, $sort, $filter, $page, $page_size, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function trackingStatsListRequest($granularity, $remote_address = null, $user_agent = null, $sort = null, $filter = null, $page = 1, $page_size = 10, string $contentType = self::contentTypes['trackingStatsList'][0])
    {
