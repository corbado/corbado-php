...
class AuthMethodsApi
{
     ...
     */
    public function authMethodsList($auth_methods_list_req)
    {
        list($response) = $this->authMethodsListWithHttpInfo($auth_methods_list_req);
        return $response;
    }
     ...
     */
    public function authMethodsListWithHttpInfo($auth_methods_list_req)
    {
        $request = $this->authMethodsListRequest($auth_methods_list_req);
     ...
     */
    public function authMethodsListAsync($auth_methods_list_req)
    {
        return $this->authMethodsListAsyncWithHttpInfo($auth_methods_list_req)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function authMethodsListAsyncWithHttpInfo($auth_methods_list_req)
    {
        $returnType = '\Corbado\Generated\Model\AuthMethodsListRsp';
        $request = $this->authMethodsListRequest($auth_methods_list_req);
     ...
     */
    public function authMethodsListRequest($auth_methods_list_req)
    {
        // verify the required parameter 'auth_methods_list_req' is set
        if ($auth_methods_list_req === null || (is_array($auth_methods_list_req) && count($auth_methods_list_req) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $auth_methods_list_req when calling authMethodsList'
            );
        }

        $resourcePath = '/v1/authMethods';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($auth_methods_list_req)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($auth_methods_list_req));
            } else {
                $httpBody = $auth_methods_list_req;
            }
