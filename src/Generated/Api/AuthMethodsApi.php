...
/**
    ...
    {
        list($response) = $this->authMethodsListWithHttpInfo($auth_methods_list_req, $contentType);
        return $response;
    }
     ...
     */
    public function authMethodsListAsync($auth_methods_list_req, string $contentType = self::contentTypes['authMethodsList'][0])
    {
        return $this->authMethodsListAsyncWithHttpInfo($auth_methods_list_req, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function authMethodsListRequest($auth_methods_list_req, string $contentType = self::contentTypes['authMethodsList'][0])
    {
        ...
        if (isset($auth_methods_list_req)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($auth_methods_list_req));
            } else {
