...
class ExamplesApi
{
     ...
     *
     * @param  string $file_name Name of the example to get (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['exampleGet'] to see the possible values for this operation
     *
     * @throws \Corbado\Generated\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Corbado\Generated\Model\ExampleGetRsp|\Corbado\Generated\Model\ErrorRsp
     */
    public function exampleGet($file_name, string $contentType = self::contentTypes['exampleGet'][0])
    {
        list($response) = $this->exampleGetWithHttpInfo($file_name, $contentType);
        return $response;
    }

    /**
     * Operation exampleGetWithHttpInfo
     *
     * @param  string $file_name Name of the example to get (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['exampleGet'] to see the possible values for this operation
     *
     * @throws \Corbado\Generated\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Corbado\Generated\Model\ExampleGetRsp|\Corbado\Generated\Model\ErrorRsp, HTTP status code, HTTP response headers (array of strings)
     */
    public function exampleGetWithHttpInfo($file_name, string $contentType = self::contentTypes['exampleGet'][0])
    {
        $request = $this->exampleGetRequest($file_name, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Corbado\Generated\Model\ExampleGetRsp' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Corbado\Generated\Model\ExampleGetRsp' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Corbado\Generated\Model\ExampleGetRsp', []),
            ...
            $returnType = '\Corbado\Generated\Model\ExampleGetRsp';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Corbado\Generated\Model\ExampleGetRsp',
     ...
     */
    public function exampleGetAsync($file_name, string $contentType = self::contentTypes['exampleGet'][0])
    {
        return $this->exampleGetAsyncWithHttpInfo($file_name, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation exampleGetAsyncWithHttpInfo
     *
     * @param  string $file_name Name of the example to get (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['exampleGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function exampleGetAsyncWithHttpInfo($file_name, string $contentType = self::contentTypes['exampleGet'][0])
    {
        $returnType = '\Corbado\Generated\Model\ExampleGetRsp';
        $request = $this->exampleGetRequest($file_name, $contentType);
    ...
    /**
     * Create request for operation 'exampleGet'
     *
     * @param  string $file_name Name of the example to get (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['exampleGet'] to see the possible values for this operation
     *
     ...
     */
    public function exampleGetRequest($file_name, string $contentType = self::contentTypes['exampleGet'][0])
    {

        // verify the required parameter 'file_name' is set
        if ($file_name === null || (is_array($file_name) && count($file_name) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $file_name when calling exampleGet'
            );
        }


        $resourcePath = '/v1/examples/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
