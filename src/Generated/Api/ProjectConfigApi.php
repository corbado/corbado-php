...
class ProjectConfigApi
{
    ...
    /**
     * Operation projectActivate
     *
     * @param  \Corbado\Generated\Model\EmptyReq $empty_req empty_req (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['projectActivate'] to see the possible values for this operation
     *
     ...
     */
    public function projectActivate($empty_req, string $contentType = self::contentTypes['projectActivate'][0])
    {
        list($response) = $this->projectActivateWithHttpInfo($empty_req, $contentType);
        return $response;
    }

    /**
     * Operation projectActivateWithHttpInfo
     *
     ...
     */
    public function projectActivateWithHttpInfo($empty_req, string $contentType = self::contentTypes['projectActivate'][0])
    {
        $request = $this->projectActivateRequest($empty_req, $contentType);
    ...
    /**
     * Operation projectActivateAsync
     *
     * @param  \Corbado\Generated\Model\EmptyReq $empty_req (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['projectActivate'] to see the possible values for this operation
     *
     ...
     */
    public function projectActivateAsync($empty_req, string $contentType = self::contentTypes['projectActivate'][0])
    {
        return $this->projectActivateAsyncWithHttpInfo($empty_req, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation projectActivateAsyncWithHttpInfo
     *
     * @param  \Corbado\Generated\Model\EmptyReq $empty_req (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['projectActivate'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function projectActivateAsyncWithHttpInfo($empty_req, string $contentType = self::contentTypes['projectActivate'][0])
    {
        $returnType = '\Corbado\Generated\Model\GenericRsp';
        $request = $this->projectActivateRequest($empty_req, $contentType);
    ...
    /**
     * Create request for operation 'projectActivate'
     *
     * @param  \Corbado\Generated\Model\EmptyReq $empty_req (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['projectActivate'] to see the possible values for this operation
     *
     ...
     */
    public function projectActivateRequest($empty_req, string $contentType = self::contentTypes['projectActivate'][0])
    {

        // verify the required parameter 'empty_req' is set
        if ($empty_req === null || (is_array($empty_req) && count($empty_req) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $empty_req when calling projectActivate'
            );
        }


        $resourcePath = '/v1/projects/activate';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
