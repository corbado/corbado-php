...
class RequestLogsApi
{
    ...
    public function requestLogGetRequest($request_id, $remote_address = null, $user_agent = null)
    {
        ...
        $resourcePath = '/v1/requestLogs/{requestID}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     */
    public function requestLogsList($remote_address = null, $user_agent = null, $sort = null, $filter = null, $page = 1, $page_size = 10)
    {
        list($response) = $this->requestLogsListWithHttpInfo($remote_address, $user_agent, $sort, $filter, $page, $page_size);
        return $response;
    }

    /**
     * Operation requestLogsListWithHttpInfo
     *
     * @param  string $remote_address Client&#39;s remote address (optional)
     * @param  string $user_agent Client&#39;s user agent (optional)
     * @param  string $sort Field sorting (optional)
     ...
     */
    public function requestLogsListWithHttpInfo($remote_address = null, $user_agent = null, $sort = null, $filter = null, $page = 1, $page_size = 10)
    {
        $request = $this->requestLogsListRequest($remote_address, $user_agent, $sort, $filter, $page, $page_size);
    ...
    /**
     * Operation requestLogsListAsync
     *
     * @param  string $remote_address Client&#39;s remote address (optional)
     * @param  string $user_agent Client&#39;s user agent (optional)
     * @param  string $sort Field sorting (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function requestLogsListAsync($remote_address = null, $user_agent = null, $sort = null, $filter = null, $page = 1, $page_size = 10)
    {
        return $this->requestLogsListAsyncWithHttpInfo($remote_address, $user_agent, $sort, $filter, $page, $page_size)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation requestLogsListAsyncWithHttpInfo
     *
     * @param  string $remote_address Client&#39;s remote address (optional)
     * @param  string $user_agent Client&#39;s user agent (optional)
     * @param  string $sort Field sorting (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function requestLogsListAsyncWithHttpInfo($remote_address = null, $user_agent = null, $sort = null, $filter = null, $page = 1, $page_size = 10)
    {
        $returnType = '\Corbado\Generated\Model\RequestLogsListRsp';
        $request = $this->requestLogsListRequest($remote_address, $user_agent, $sort, $filter, $page, $page_size);
    ...
    /**
     * Create request for operation 'requestLogsList'
     *
     * @param  string $remote_address Client&#39;s remote address (optional)
     * @param  string $user_agent Client&#39;s user agent (optional)
     * @param  string $sort Field sorting (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function requestLogsListRequest($remote_address = null, $user_agent = null, $sort = null, $filter = null, $page = 1, $page_size = 10)
    {

        $resourcePath = '/v1/requestLogs';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
