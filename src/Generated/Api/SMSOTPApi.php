...
class SMSOTPApi
{
    ...
    {
        list($response) = $this->smsCodeSendWithHttpInfo($sms_code_send_req, $contentType);
        return $response;
    }
     ...
     */
    public function smsCodeSendAsync($sms_code_send_req, string $contentType = self::contentTypes['smsCodeSend'][0])
    {
        return $this->smsCodeSendAsyncWithHttpInfo($sms_code_send_req, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function smsCodeSendRequest($sms_code_send_req, string $contentType = self::contentTypes['smsCodeSend'][0])
    {
        ...
        if (isset($sms_code_send_req)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($sms_code_send_req));
            } else {
     ...
     * @throws \Corbado\Generated\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Corbado\Generated\Model\SmsCodeValidateRsp|\Corbado\Generated\Model\ErrorRsp
     */
    public function smsCodeValidate($sms_code_id, $sms_code_validate_req, string $contentType = self::contentTypes['smsCodeValidate'][0])
    {
        list($response) = $this->smsCodeValidateWithHttpInfo($sms_code_id, $sms_code_validate_req, $contentType);
        return $response;
    }
     ...
     * @throws \Corbado\Generated\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Corbado\Generated\Model\SmsCodeValidateRsp|\Corbado\Generated\Model\ErrorRsp, HTTP status code, HTTP response headers (array of strings)
     */
    public function smsCodeValidateWithHttpInfo($sms_code_id, $sms_code_validate_req, string $contentType = self::contentTypes['smsCodeValidate'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Corbado\Generated\Model\SmsCodeValidateRsp' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Corbado\Generated\Model\SmsCodeValidateRsp' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Corbado\Generated\Model\SmsCodeValidateRsp', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\Corbado\Generated\Model\SmsCodeValidateRsp';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Corbado\Generated\Model\SmsCodeValidateRsp',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function smsCodeValidateAsync($sms_code_id, $sms_code_validate_req, string $contentType = self::contentTypes['smsCodeValidate'][0])
    {
        return $this->smsCodeValidateAsyncWithHttpInfo($sms_code_id, $sms_code_validate_req, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function smsCodeValidateRequest($sms_code_id, $sms_code_validate_req, string $contentType = self::contentTypes['smsCodeValidate'][0])
    {
        ...
        if (isset($sms_code_validate_req)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($sms_code_validate_req));
            } else {
