...
class SMSTemplatesApi
{
    ...
    {
        list($response) = $this->smsTemplateCreateWithHttpInfo($sms_template_create_req, $contentType);
        return $response;
    }
     ...
     */
    public function smsTemplateCreateAsync($sms_template_create_req, string $contentType = self::contentTypes['smsTemplateCreate'][0])
    {
        return $this->smsTemplateCreateAsyncWithHttpInfo($sms_template_create_req, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function smsTemplateCreateRequest($sms_template_create_req, string $contentType = self::contentTypes['smsTemplateCreate'][0])
    {
        ...
        if (isset($sms_template_create_req)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($sms_template_create_req));
            } else {
    ...
    {
        list($response) = $this->smsTemplateDeleteWithHttpInfo($sms_template_id, $sms_template_delete_req, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function smsTemplateDeleteAsync($sms_template_id, $sms_template_delete_req, string $contentType = self::contentTypes['smsTemplateDelete'][0])
    {
        return $this->smsTemplateDeleteAsyncWithHttpInfo($sms_template_id, $sms_template_delete_req, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function smsTemplateDeleteRequest($sms_template_id, $sms_template_delete_req, string $contentType = self::contentTypes['smsTemplateDelete'][0])
    {
        ...
        if (isset($sms_template_delete_req)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($sms_template_delete_req));
            } else {
