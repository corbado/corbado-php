...
class ValidationApi
{
     ...
     */
    public function validateEmail($validate_email_req)
    {
        list($response) = $this->validateEmailWithHttpInfo($validate_email_req);
        return $response;
    }
     ...
     */
    public function validateEmailWithHttpInfo($validate_email_req)
    {
        $request = $this->validateEmailRequest($validate_email_req);
     ...
     */
    public function validateEmailAsync($validate_email_req)
    {
        return $this->validateEmailAsyncWithHttpInfo($validate_email_req)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function validateEmailAsyncWithHttpInfo($validate_email_req)
    {
        $returnType = '\Corbado\Generated\Model\ValidateEmailRsp';
        $request = $this->validateEmailRequest($validate_email_req);
     ...
     */
    public function validateEmailRequest($validate_email_req)
    {
        ...
        if (isset($validate_email_req)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($validate_email_req));
            } else {
     ...
     */
    public function validatePhoneNumber($validate_phone_number_req)
    {
        list($response) = $this->validatePhoneNumberWithHttpInfo($validate_phone_number_req);
        return $response;
    }
     ...
     */
    public function validatePhoneNumberWithHttpInfo($validate_phone_number_req)
    {
        $request = $this->validatePhoneNumberRequest($validate_phone_number_req);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function validatePhoneNumberAsync($validate_phone_number_req)
    {
        return $this->validatePhoneNumberAsyncWithHttpInfo($validate_phone_number_req)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function validatePhoneNumberAsyncWithHttpInfo($validate_phone_number_req)
    {
        $returnType = '\Corbado\Generated\Model\ValidatePhoneNumberRsp';
        $request = $this->validatePhoneNumberRequest($validate_phone_number_req);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function validatePhoneNumberRequest($validate_phone_number_req)
    {
        ...
        if (isset($validate_phone_number_req)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($validate_phone_number_req));
            } else {
