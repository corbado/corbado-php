...
/**
     ...
     * @return \CorbadoGenerated\Model\WebhookLogsListRsp|\CorbadoGenerated\Model\ErrorRsp
     */
     ...
     * @throws \CorbadoGenerated\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \CorbadoGenerated\Model\WebhookLogsListRsp|\CorbadoGenerated\Model\ErrorRsp, HTTP status code, HTTP response headers (array of strings)
     */
    public function webhookLogsListWithHttpInfo($remote_address = null, $user_agent = null, $sort = null, $filter = null, $page = 1, $page_size = 10, string $contentType = self::contentTypes['webhookLogsList'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\CorbadoGenerated\Model\WebhookLogsListRsp' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\CorbadoGenerated\Model\WebhookLogsListRsp' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\CorbadoGenerated\Model\WebhookLogsListRsp', []),
            ...
            $returnType = '\CorbadoGenerated\Model\WebhookLogsListRsp';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CorbadoGenerated\Model\WebhookLogsListRsp',
