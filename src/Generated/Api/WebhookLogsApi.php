...
/**
 * WebhookLogsApi Class Doc Comment
 *
 * @category Class
 * @package  Corbado\Generated
 * @author   OpenAPI Generator team
...
class WebhookLogsApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookLogsList'] to see the possible values for this operation
     *
     * @throws \Corbado\Generated\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Corbado\Generated\Model\WebhookLogsListRsp|\Corbado\Generated\Model\ErrorRsp
     */
    public function webhookLogsList($remote_address = null, $user_agent = null, $sort = null, $filter = null, $page = 1, $page_size = 10, string $contentType = self::contentTypes['webhookLogsList'][0])
    {
        list($response) = $this->webhookLogsListWithHttpInfo($remote_address, $user_agent, $sort, $filter, $page, $page_size, $contentType);
        return $response;
    }

    /**
     * Operation webhookLogsListWithHttpInfo
     *
     * @param  string $remote_address Client&#39;s remote address (optional)
     * @param  string $user_agent Client&#39;s user agent (optional)
     * @param  string $sort Field sorting (optional)
     ...
     * @throws \Corbado\Generated\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Corbado\Generated\Model\WebhookLogsListRsp|\Corbado\Generated\Model\ErrorRsp, HTTP status code, HTTP response headers (array of strings)
     */
    public function webhookLogsListWithHttpInfo($remote_address = null, $user_agent = null, $sort = null, $filter = null, $page = 1, $page_size = 10, string $contentType = self::contentTypes['webhookLogsList'][0])
    {
        $request = $this->webhookLogsListRequest($remote_address, $user_agent, $sort, $filter, $page, $page_size, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Corbado\Generated\Model\WebhookLogsListRsp' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Corbado\Generated\Model\WebhookLogsListRsp' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Corbado\Generated\Model\WebhookLogsListRsp', []),
            ...
            $returnType = '\Corbado\Generated\Model\WebhookLogsListRsp';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Corbado\Generated\Model\WebhookLogsListRsp',
    ...
    /**
     * Operation webhookLogsListAsync
     *
     * @param  string $remote_address Client&#39;s remote address (optional)
     * @param  string $user_agent Client&#39;s user agent (optional)
     * @param  string $sort Field sorting (optional)
     ...
     */
    public function webhookLogsListAsync($remote_address = null, $user_agent = null, $sort = null, $filter = null, $page = 1, $page_size = 10, string $contentType = self::contentTypes['webhookLogsList'][0])
    {
        return $this->webhookLogsListAsyncWithHttpInfo($remote_address, $user_agent, $sort, $filter, $page, $page_size, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation webhookLogsListAsyncWithHttpInfo
     *
     * @param  string $remote_address Client&#39;s remote address (optional)
     * @param  string $user_agent Client&#39;s user agent (optional)
     * @param  string $sort Field sorting (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhookLogsListAsyncWithHttpInfo($remote_address = null, $user_agent = null, $sort = null, $filter = null, $page = 1, $page_size = 10, string $contentType = self::contentTypes['webhookLogsList'][0])
    {
        $returnType = '\Corbado\Generated\Model\WebhookLogsListRsp';
        $request = $this->webhookLogsListRequest($remote_address, $user_agent, $sort, $filter, $page, $page_size, $contentType);
    ...
    /**
     * Create request for operation 'webhookLogsList'
     *
     * @param  string $remote_address Client&#39;s remote address (optional)
     * @param  string $user_agent Client&#39;s user agent (optional)
     * @param  string $sort Field sorting (optional)
     ...
     */
    public function webhookLogsListRequest($remote_address = null, $user_agent = null, $sort = null, $filter = null, $page = 1, $page_size = 10, string $contentType = self::contentTypes['webhookLogsList'][0])
    {
