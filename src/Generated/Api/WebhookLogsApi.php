...
class WebhookLogsApi
{
     ...
     */
    public function webhookLogsList($remote_address = null, $user_agent = null, $sort = null, $filter = null, $page = 1, $page_size = 10)
    {
        list($response) = $this->webhookLogsListWithHttpInfo($remote_address, $user_agent, $sort, $filter, $page, $page_size);
        return $response;
    }
     ...
     */
    public function webhookLogsListWithHttpInfo($remote_address = null, $user_agent = null, $sort = null, $filter = null, $page = 1, $page_size = 10)
    {
        $request = $this->webhookLogsListRequest($remote_address, $user_agent, $sort, $filter, $page, $page_size);
     ...
     */
    public function webhookLogsListAsync($remote_address = null, $user_agent = null, $sort = null, $filter = null, $page = 1, $page_size = 10)
    {
        return $this->webhookLogsListAsyncWithHttpInfo($remote_address, $user_agent, $sort, $filter, $page, $page_size)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhookLogsListAsyncWithHttpInfo($remote_address = null, $user_agent = null, $sort = null, $filter = null, $page = 1, $page_size = 10)
    {
        $returnType = '\Corbado\Generated\Model\WebhookLogsListRsp';
        $request = $this->webhookLogsListRequest($remote_address, $user_agent, $sort, $filter, $page, $page_size);
     ...
     */
    public function webhookLogsListRequest($remote_address = null, $user_agent = null, $sort = null, $filter = null, $page = 1, $page_size = 10)
    {
