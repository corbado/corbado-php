...
/**
 * AndroidAppConfigListRsp Class Doc Comment
 *
 * @category Class
 * @package  Corbado\Generated
 * @author   OpenAPI Generator team
 ...
 */
class AndroidAppConfigListRsp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'androidAppConfigListRsp';
    ...
    protected static $openAPITypes = [
        ...
        'runtime' => 'float',
        'rows' => '\Corbado\Generated\Model\AndroidAppConfigItem[]',
    ...
    */
    ...
    public function setHttpStatusCode($http_status_code)
    {
        ...
        if (($http_status_code > 599)) {
            throw new \InvalidArgumentException('invalid value for $http_status_code when calling AndroidAppConfigListRsp., must be smaller than or equal to 599.');
        }
        if (($http_status_code < 200)) {
            throw new \InvalidArgumentException('invalid value for $http_status_code when calling AndroidAppConfigListRsp., must be bigger than or equal to 200.');
        }
     ...
     * Gets rows
     *
     * @return \Corbado\Generated\Model\AndroidAppConfigItem[]
     */
     ...
     * Sets rows
     *
     * @param \Corbado\Generated\Model\AndroidAppConfigItem[] $rows rows
     *
     * @return self
     */
