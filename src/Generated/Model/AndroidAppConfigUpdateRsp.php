...
/**
 * AndroidAppConfigUpdateRsp Class Doc Comment
 *
 * @category Class
 * @package  Corbado\Generated
 * @author   OpenAPI Generator team
 ...
 */
class AndroidAppConfigUpdateRsp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'androidAppConfigUpdateRsp';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('base64_url', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['base64_url'] === null) {
            $invalidProperties[] = "'base64_url' can't be null";
        }
    ...
    public function setHttpStatusCode($http_status_code)
    {
        ...
        if (($http_status_code > 599)) {
            throw new \InvalidArgumentException('invalid value for $http_status_code when calling AndroidAppConfigUpdateRsp., must be smaller than or equal to 599.');
        }
        if (($http_status_code < 200)) {
            throw new \InvalidArgumentException('invalid value for $http_status_code when calling AndroidAppConfigUpdateRsp., must be bigger than or equal to 200.');
        }
     ...
     * Sets id
     *
     * @param string $id ID of Android app configuration
     *
     * @return self
     */
    ...
    {
        return $this->container['base64_url'];
    }

    /**
     * Sets base64_url
     *
     * @param string $base64_url base64_url
     *
     * @return self
     */
    public function setBase64Url($base64_url)
    {
        if (is_null($base64_url)) {
            throw new \InvalidArgumentException('non-nullable base64_url cannot be null');
        }
        $this->container['base64_url'] = $base64_url;
