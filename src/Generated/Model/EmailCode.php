 ...
 */
class EmailCode implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'emailCode';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id ID of the email OTP
     *
     * @return self
     */
     ...
     *
     * @param string $additional_payload Additional payload in JSON format
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status status values of an email OTP
     *
     * @return self
     */
