...
/**
 * EmailCodeGetRspAllOfData Class Doc Comment
 *
 * @category Class
 * @package  Corbado\Generated
 * @author   OpenAPI Generator team
 ...
 */
class EmailCodeGetRspAllOfData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'emailCodeGetRsp_allOf_data';
    ...
    protected static $openAPITypes = [
        'email_code' => '\Corbado\Generated\Model\EmailCode'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['email_code'] === null) {
            $invalidProperties[] = "'email_code' can't be null";
        }
     ...
     * Gets email_code
     *
     * @return \Corbado\Generated\Model\EmailCode
     */
     ...
     * Sets email_code
     *
     * @param \Corbado\Generated\Model\EmailCode $email_code email_code
     *
     * @return self
     */
    public function setEmailCode($email_code)
    {
        if (is_null($email_code)) {
            throw new \InvalidArgumentException('non-nullable email_code cannot be null');
        }
