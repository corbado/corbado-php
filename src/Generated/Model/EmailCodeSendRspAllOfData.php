...
/**
 * EmailCodeSendRspAllOfData Class Doc Comment
 *
 * @category Class
 * @package  Corbado\Generated
 * @author   OpenAPI Generator team
 ...
 */
class EmailCodeSendRspAllOfData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'emailCodeSendRsp_allOf_data';
    ...
    {
        $this->setIfExists('email_code_id', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['email_code_id'] === null) {
            $invalidProperties[] = "'email_code_id' can't be null";
        }
     ...
     * @return string
     */
    public function getEmailCodeId()
    {
        return $this->container['email_code_id'];
    }

    /**
     * Sets email_code_id
     *
     * @param string $email_code_id email_code_id
     *
     * @return self
     */
    public function setEmailCodeId($email_code_id)
    {
        if (is_null($email_code_id)) {
            throw new \InvalidArgumentException('non-nullable email_code_id cannot be null');
        }
        $this->container['email_code_id'] = $email_code_id;
