 ...
 */
class EmailLink implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'emailLink';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['additional_payload'] === null) {
            $invalidProperties[] = "'additional_payload' can't be null";
        }
     ...
     * Sets id
     *
     * @param string $id ID of the email magic link
     *
     * @return self
     */
     ...
     * Sets user_full_name
     *
     * @param string|null $user_full_name user_full_name
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status status values of an email link
     *
     * @return self
     */
     ...
     *
     * @param string $additional_payload Additional payload
     *
     * @return self
     */
