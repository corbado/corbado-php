 ...
 */
class EmailLinkGetRspAllOfData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'emailLinkGetRsp_allOf_data';
    ...
    {
        $this->setIfExists('email_link', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['email_link'] === null) {
            $invalidProperties[] = "'email_link' can't be null";
        }
    ...
    public function setEmailLink($email_link)
    {
        if (is_null($email_link)) {
            throw new \InvalidArgumentException('non-nullable email_link cannot be null');
        }
