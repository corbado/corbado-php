...
/**
 * EmailLinkSendRspAllOfData Class Doc Comment
 *
 * @category Class
 * @package  Corbado\Generated
 * @author   OpenAPI Generator team
 ...
 */
class EmailLinkSendRspAllOfData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'emailLinkSendRsp_allOf_data';
    ...
    {
        $this->setIfExists('email_link_id', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['email_link_id'] === null) {
            $invalidProperties[] = "'email_link_id' can't be null";
        }
     ...
     * Sets email_link_id
     *
     * @param string $email_link_id email_link_id
     *
     * @return self
     */
    public function setEmailLinkId($email_link_id)
    {
        if (is_null($email_link_id)) {
            throw new \InvalidArgumentException('non-nullable email_link_id cannot be null');
        }
