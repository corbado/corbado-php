...
/**
 * EmailLinkValidateRsp Class Doc Comment
 *
 * @category Class
 * @package  Corbado\Generated
 * @author   OpenAPI Generator team
 ...
 */
class EmailLinkValidateRsp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'emailLinkValidateRsp';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['additional_payload'] = $data['additional_payload'] ?? null;
    ...
    public function setHttpStatusCode($http_status_code)
    {
        ...
        if (($http_status_code > 599)) {
            throw new \InvalidArgumentException('invalid value for $http_status_code when calling EmailLinkValidateRsp., must be smaller than or equal to 599.');
        }
        if (($http_status_code < 200)) {
            throw new \InvalidArgumentException('invalid value for $http_status_code when calling EmailLinkValidateRsp., must be bigger than or equal to 200.');
        }
     ...
     *
     * @param string|null $additional_payload additional_payload
     *
     * @return self
     */
