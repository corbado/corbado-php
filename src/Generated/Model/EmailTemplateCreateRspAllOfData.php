...
/**
 * EmailTemplateCreateRspAllOfData Class Doc Comment
 *
 * @category Class
 * @package  Corbado\Generated
 * @author   OpenAPI Generator team
 ...
 */
class EmailTemplateCreateRspAllOfData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'emailTemplateCreateRsp_allOf_data';
    ...
    {
        $this->container['email_template_id'] = $data['email_template_id'] ?? null;
    }
