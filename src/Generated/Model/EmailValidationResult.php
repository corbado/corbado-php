...
class EmailValidationResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const VALIDATION_CODE_INVALID_SYNTAX = 'invalid_syntax';
    public const VALIDATION_CODE_NO_SUCH_HOST = 'no_such_host';
    public const VALIDATION_CODE_NOT_ALLOWED = 'not_allowed';
    public const VALIDATION_CODE_UNKNOWN = 'unknown';
