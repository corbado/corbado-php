...
class EmailValidationResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    const VALIDATION_CODE_INVALID_SYNTAX = 'invalid_syntax';
    const VALIDATION_CODE_NO_SUCH_HOST = 'no_such_host';
    const VALIDATION_CODE_NOT_ALLOWED = 'not_allowed';
    const VALIDATION_CODE_UNKNOWN = 'unknown';
    ...
    public function getValidationCodeAllowableValues()
    {
        return [
            ...
            self::VALIDATION_CODE_INVALID_SYNTAX,
            self::VALIDATION_CODE_NO_SUCH_HOST,
            self::VALIDATION_CODE_NOT_ALLOWED,
            self::VALIDATION_CODE_UNKNOWN,
        ];
    }
