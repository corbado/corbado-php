 ...
 */
class ErrorRspAllOfError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'errorRsp_allOf_error';
    ...
    */
     ...
     * Sets details
     *
     * @param string|null $details Details of error
     *
     * @return self
     */
     ...
     * Sets links
     *
     * @param string[] $links Additional links to help understand the error
     *
     * @return self
     */
