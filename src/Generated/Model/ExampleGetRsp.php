...
/**
 * ExampleGetRsp Class Doc Comment
 *
 * @category Class
 * @package  Corbado\Generated
 * @author   OpenAPI Generator team
 ...
 */
class ExampleGetRsp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'exampleGetRsp';
    ...
    public const EXTENSION_ZIP = 'zip';
    public const EXTENSION_TAR_GZ = 'tar.gz';
    ...
    */
    ...
    public function setHttpStatusCode($http_status_code)
    {
        ...
        if (($http_status_code > 599)) {
            throw new \InvalidArgumentException('invalid value for $http_status_code when calling ExampleGetRsp., must be smaller than or equal to 599.');
        }
        if (($http_status_code < 200)) {
            throw new \InvalidArgumentException('invalid value for $http_status_code when calling ExampleGetRsp., must be bigger than or equal to 200.');
        }
     ...
     * Sets data
     *
     * @param string $data Base64 encoded data containing the compressed example file
     *
     * @return self
     */
     ...
     * Sets extension
     *
     * @param string $extension The extension of the compressed example file
     *
     * @return self
     */
