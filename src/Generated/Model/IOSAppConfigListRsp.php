...
/**
 * IOSAppConfigListRsp Class Doc Comment
 *
 * @category Class
 * @package  Corbado\Generated
 * @author   OpenAPI Generator team
 ...
 */
class IOSAppConfigListRsp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'iOSAppConfigListRsp';
    ...
    protected static $openAPITypes = [
        ...
        'runtime' => 'float',
        'rows' => '\Corbado\Generated\Model\IOSAppConfigItem[]',
    ...
    */
    ...
    public function setHttpStatusCode($http_status_code)
    {
        ...
        if (($http_status_code > 599)) {
            throw new \InvalidArgumentException('invalid value for $http_status_code when calling IOSAppConfigListRsp., must be smaller than or equal to 599.');
        }
        if (($http_status_code < 200)) {
            throw new \InvalidArgumentException('invalid value for $http_status_code when calling IOSAppConfigListRsp., must be bigger than or equal to 200.');
        }
     ...
     * Gets rows
     *
     * @return \Corbado\Generated\Model\IOSAppConfigItem[]
     */
     ...
     * Sets rows
     *
     * @param \Corbado\Generated\Model\IOSAppConfigItem[] $rows rows
     *
     * @return self
     */
