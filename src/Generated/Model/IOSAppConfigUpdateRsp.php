...
/**
 * IOSAppConfigUpdateRsp Class Doc Comment
 *
 * @category Class
 * @package  Corbado\Generated
 * @author   OpenAPI Generator team
 ...
 */
class IOSAppConfigUpdateRsp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'iOSAppConfigUpdateRsp';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('app_id_prefix', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['app_id_prefix'] === null) {
            $invalidProperties[] = "'app_id_prefix' can't be null";
        }
    ...
    public function setHttpStatusCode($http_status_code)
    {
        ...
        if (($http_status_code > 599)) {
            throw new \InvalidArgumentException('invalid value for $http_status_code when calling IOSAppConfigUpdateRsp., must be smaller than or equal to 599.');
        }
        if (($http_status_code < 200)) {
            throw new \InvalidArgumentException('invalid value for $http_status_code when calling IOSAppConfigUpdateRsp., must be bigger than or equal to 200.');
        }
     ...
     * @return string
     */
    public function getAppIdPrefix()
    {
        return $this->container['app_id_prefix'];
    }

    /**
     * Sets app_id_prefix
     *
     * @param string $app_id_prefix app_id_prefix
     *
     * @return self
     */
    public function setAppIdPrefix($app_id_prefix)
    {
        if (is_null($app_id_prefix)) {
            throw new \InvalidArgumentException('non-nullable app_id_prefix cannot be null');
        }
        $this->container['app_id_prefix'] = $app_id_prefix;
