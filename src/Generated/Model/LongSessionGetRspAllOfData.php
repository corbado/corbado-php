...
/**
 * LongSessionGetRspAllOfData Class Doc Comment
 *
 * @category Class
 * @package  Corbado\Generated
 * @author   OpenAPI Generator team
 ...
 */
class LongSessionGetRspAllOfData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'longSessionGetRsp_allOf_data';
    ...
    protected static $openAPITypes = [
        'long_session' => '\Corbado\Generated\Model\LongSession'
    ];
    ...
    {
        $this->setIfExists('long_session', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['long_session'] === null) {
            $invalidProperties[] = "'long_session' can't be null";
        }
     ...
     * Gets long_session
     *
     * @return \Corbado\Generated\Model\LongSession
     */
    public function getLongSession()
    {
        return $this->container['long_session'];
    }

    /**
     * Sets long_session
     *
     * @param \Corbado\Generated\Model\LongSession $long_session long_session
     *
     * @return self
     */
    public function setLongSession($long_session)
    {
        if (is_null($long_session)) {
            throw new \InvalidArgumentException('non-nullable long_session cannot be null');
        }
        $this->container['long_session'] = $long_session;
