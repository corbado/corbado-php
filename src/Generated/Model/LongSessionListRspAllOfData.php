...
/**
 * LongSessionListRspAllOfData Class Doc Comment
 *
 * @category Class
 * @package  Corbado\Generated
 * @author   OpenAPI Generator team
 ...
 */
class LongSessionListRspAllOfData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'longSessionListRsp_allOf_data';
    ...
    protected static $openAPITypes = [
        'long_sessions' => '\Corbado\Generated\Model\LongSession[]',
    ...
    {
        $this->setIfExists('long_sessions', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['long_sessions'] === null) {
            $invalidProperties[] = "'long_sessions' can't be null";
        }
    ...
    {
        return $this->container['long_sessions'];
    }

    /**
     * Sets long_sessions
     *
     * @param \Corbado\Generated\Model\LongSession[] $long_sessions long_sessions
     *
     * @return self
     */
    public function setLongSessions($long_sessions)
    {
        if (is_null($long_sessions)) {
            throw new \InvalidArgumentException('non-nullable long_sessions cannot be null');
        }
        $this->container['long_sessions'] = $long_sessions;
