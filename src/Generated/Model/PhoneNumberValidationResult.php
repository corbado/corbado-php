 ...
 */
class PhoneNumberValidationResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'phoneNumberValidationResult';
    ...
    const VALIDATION_CODE_VALID = 'valid';
    const VALIDATION_CODE_INVALID_COUNTRY_CODE = 'invalid_country_code';
    const VALIDATION_CODE_INVALID_NUMBER = 'invalid_number';
    const VALIDATION_CODE_TOO_LONG = 'too_long';
    ...
    {
        return [
            self::VALIDATION_CODE_VALID,
            self::VALIDATION_CODE_INVALID_COUNTRY_CODE,
            self::VALIDATION_CODE_INVALID_NUMBER,
            self::VALIDATION_CODE_TOO_LONG,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['validation_code'] = $data['validation_code'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['validation_code'] === null) {
            $invalidProperties[] = "'validation_code' can't be null";
        }
        ...
        if (!is_null($this->container['validation_code']) && !in_array($this->container['validation_code'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'validation_code', must be one of '%s'",
                $this->container['validation_code'],
     ...
     *
     * @param string $validation_code validation_code
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getValidationCodeAllowableValues();
        if (!in_array($validation_code, $allowedValues, true)) {
