...
class PhoneNumberValidationResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const VALIDATION_CODE_VALID = 'valid';
    public const VALIDATION_CODE_INVALID_COUNTRY_CODE = 'invalid_country_code';
    public const VALIDATION_CODE_INVALID_NUMBER = 'invalid_number';
    public const VALIDATION_CODE_TOO_LONG = 'too_long';
