...
class ProjectConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'has_started_using_sessions' => 'bool',
        'environment' => 'string',
        ...
        'signup_flow' => 'string',
        'signup_flow_options' => 'object',
        'login_flow' => 'string',
        'login_flow_options' => 'object',
        'created' => 'string',
        'updated' => 'string',
        'status' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'has_started_using_sessions' => null,
        'environment' => null,
        ...
        'smtp_password' => null,
        'support_email' => null,
        'webhook_actions' => null,
        'signup_flow' => null,
        'signup_flow_options' => null,
        'login_flow' => null,
        'login_flow_options' => null,
        'created' => null,
        'updated' => null,
        'status' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'has_started_using_sessions' => false,
        'environment' => false,
        'frontend_framework' => false,
        'backend_language' => false,
        ...
        'signup_flow' => false,
        'signup_flow_options' => false,
        'login_flow' => false,
        'login_flow_options' => false,
        'created' => false,
        'updated' => false,
        'status' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'has_started_using_sessions' => 'hasStartedUsingSessions',
        ...
        'webhook_actions' => 'webhookActions',
        'signup_flow' => 'signupFlow',
        'signup_flow_options' => 'signupFlowOptions',
        'login_flow' => 'loginFlow',
        'login_flow_options' => 'loginFlowOptions',
        'created' => 'created',
        'updated' => 'updated',
        'status' => 'status'
    ];
    ...
    protected static $setters = [
        ...
        'has_started_using_sessions' => 'setHasStartedUsingSessions',
        'environment' => 'setEnvironment',
        'frontend_framework' => 'setFrontendFramework',
        'backend_language' => 'setBackendLanguage',
        ...
        'webhook_actions' => 'setWebhookActions',
        'signup_flow' => 'setSignupFlow',
        'signup_flow_options' => 'setSignupFlowOptions',
        'login_flow' => 'setLoginFlow',
        'login_flow_options' => 'setLoginFlowOptions',
        'created' => 'setCreated',
        'updated' => 'setUpdated',
        'status' => 'setStatus'
    ];
    ...
    protected static $getters = [
        ...
        'has_started_using_sessions' => 'getHasStartedUsingSessions',
        'environment' => 'getEnvironment',
        'frontend_framework' => 'getFrontendFramework',
        'backend_language' => 'getBackendLanguage',
        ...
        'webhook_actions' => 'getWebhookActions',
        'signup_flow' => 'getSignupFlow',
        'signup_flow_options' => 'getSignupFlowOptions',
        'login_flow' => 'getLoginFlow',
        'login_flow_options' => 'getLoginFlowOptions',
        'created' => 'getCreated',
        'updated' => 'getUpdated',
        'status' => 'getStatus'
    ];
    ...
    public const PASSKEY_APPEND_INTERVAL_NOT_SPECIFIED = 'not_specified';
    ...
    public const FRONTEND_FRAMEWORK_NOT_SPECIFIED = 'not_specified';
    public const FRONTEND_FRAMEWORK_REACT = 'react';
    public const FRONTEND_FRAMEWORK_VUEJS = 'vuejs';
    public const FRONTEND_FRAMEWORK_VANILLAJS = 'vanillajs';
    public const BACKEND_LANGUAGE_NOT_SPECIFIED = 'not_specified';
    public const BACKEND_LANGUAGE_JAVASCRIPT = 'javascript';
    public const BACKEND_LANGUAGE_PHP = 'php';
    public const BACKEND_LANGUAGE_GO = 'go';
    public const SIGNUP_FLOW_PASSKEY_WITH_EMAIL_OTP_FALLBACK = 'PasskeyWithEmailOTPFallback';
    public const SIGNUP_FLOW_EMAIL_OTP_SIGNUP = 'EmailOTPSignup';
    public const LOGIN_FLOW_PASSKEY_WITH_EMAIL_OTP_FALLBACK = 'PasskeyWithEmailOTPFallback';
    ...
    {
        return [
            self::PASSKEY_APPEND_INTERVAL_NOT_SPECIFIED,
     ...
     * @return string[]
     */
    public function getFrontendFrameworkAllowableValues()
    {
        return [
            self::FRONTEND_FRAMEWORK_NOT_SPECIFIED,
            self::FRONTEND_FRAMEWORK_REACT,
            self::FRONTEND_FRAMEWORK_VUEJS,
            self::FRONTEND_FRAMEWORK_VANILLAJS,
        ];
    }
     ...
     * @return string[]
     */
    public function getBackendLanguageAllowableValues()
    {
        return [
            self::BACKEND_LANGUAGE_NOT_SPECIFIED,
            self::BACKEND_LANGUAGE_JAVASCRIPT,
            self::BACKEND_LANGUAGE_PHP,
            self::BACKEND_LANGUAGE_GO,
        ];
    }
     ...
     * @return string[]
     */
    public function getSignupFlowAllowableValues()
    {
        return [
            self::SIGNUP_FLOW_PASSKEY_WITH_EMAIL_OTP_FALLBACK,
            self::SIGNUP_FLOW_EMAIL_OTP_SIGNUP,
        ];
    }
     ...
     * @return string[]
     */
    public function getLoginFlowAllowableValues()
    {
        return [
            self::LOGIN_FLOW_PASSKEY_WITH_EMAIL_OTP_FALLBACK,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('product_key', $data ?? [], null);
        ...
        $this->setIfExists('has_started_using_sessions', $data ?? [], null);
        $this->setIfExists('environment', $data ?? [], null);
        $this->setIfExists('frontend_framework', $data ?? [], null);
        $this->setIfExists('backend_language', $data ?? [], null);
        ...
        $this->setIfExists('webhook_actions', $data ?? [], null);
        $this->setIfExists('signup_flow', $data ?? [], null);
        $this->setIfExists('signup_flow_options', $data ?? [], null);
        $this->setIfExists('login_flow', $data ?? [], null);
        $this->setIfExists('login_flow_options', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['external_application_protocol_version'] === null) {
            $invalidProperties[] = "'external_application_protocol_version' can't be null";
        }
        if ($this->container['webhook_url'] === null) {
            $invalidProperties[] = "'webhook_url' can't be null";
        }
        if ($this->container['webhook_username'] === null) {
            $invalidProperties[] = "'webhook_username' can't be null";
        }
        if ($this->container['webhook_password'] === null) {
            $invalidProperties[] = "'webhook_password' can't be null";
        }
        if ($this->container['webhook_test_invalid_username'] === null) {
            $invalidProperties[] = "'webhook_test_invalid_username' can't be null";
        }
        if ($this->container['webhook_test_valid_username'] === null) {
            $invalidProperties[] = "'webhook_test_valid_username' can't be null";
        }
        if ($this->container['webhook_test_valid_password'] === null) {
            $invalidProperties[] = "'webhook_test_valid_password' can't be null";
        }
        if ($this->container['external_application_username'] === null) {
            $invalidProperties[] = "'external_application_username' can't be null";
        }
        if ($this->container['external_application_password'] === null) {
            $invalidProperties[] = "'external_application_password' can't be null";
        }
        if ($this->container['legacy_auth_methods_url'] === null) {
            $invalidProperties[] = "'legacy_auth_methods_url' can't be null";
        }
        if ($this->container['password_verify_url'] === null) {
            $invalidProperties[] = "'password_verify_url' can't be null";
        }
        if ($this->container['auth_success_redirect_url'] === null) {
            $invalidProperties[] = "'auth_success_redirect_url' can't be null";
        }
        if ($this->container['password_reset_url'] === null) {
            $invalidProperties[] = "'password_reset_url' can't be null";
        }
        if ($this->container['allow_user_registration'] === null) {
            $invalidProperties[] = "'allow_user_registration' can't be null";
        }
        if ($this->container['allow_ip_stickiness'] === null) {
            $invalidProperties[] = "'allow_ip_stickiness' can't be null";
        }
        if ($this->container['passkey_append_interval'] === null) {
            $invalidProperties[] = "'passkey_append_interval' can't be null";
        }
        ...
        if ($this->container['cli_secret'] === null) {
            $invalidProperties[] = "'cli_secret' can't be null";
        }
        ...
        if ($this->container['has_started_using_sessions'] === null) {
            $invalidProperties[] = "'has_started_using_sessions' can't be null";
        }
        ...
        if ($this->container['frontend_framework'] === null) {
            $invalidProperties[] = "'frontend_framework' can't be null";
        }
        $allowedValues = $this->getFrontendFrameworkAllowableValues();
        if (!is_null($this->container['frontend_framework']) && !in_array($this->container['frontend_framework'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'frontend_framework', must be one of '%s'",
                $this->container['frontend_framework'],
                implode("', '", $allowedValues)
            );
        }

        if ($this->container['backend_language'] === null) {
            $invalidProperties[] = "'backend_language' can't be null";
        }
        $allowedValues = $this->getBackendLanguageAllowableValues();
        if (!is_null($this->container['backend_language']) && !in_array($this->container['backend_language'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'backend_language', must be one of '%s'",
                $this->container['backend_language'],
                implode("', '", $allowedValues)
            );
        }
        ...
        if ($this->container['smtp_use_custom'] === null) {
            $invalidProperties[] = "'smtp_use_custom' can't be null";
        }
        ...
        if ($this->container['webhook_actions'] === null) {
            $invalidProperties[] = "'webhook_actions' can't be null";
        }
        if ($this->container['signup_flow'] === null) {
            $invalidProperties[] = "'signup_flow' can't be null";
        }
        $allowedValues = $this->getSignupFlowAllowableValues();
        if (!is_null($this->container['signup_flow']) && !in_array($this->container['signup_flow'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'signup_flow', must be one of '%s'",
                $this->container['signup_flow'],
                implode("', '", $allowedValues)
            );
        }

        if ($this->container['signup_flow_options'] === null) {
            $invalidProperties[] = "'signup_flow_options' can't be null";
        }
        if ($this->container['login_flow'] === null) {
            $invalidProperties[] = "'login_flow' can't be null";
        }
        $allowedValues = $this->getLoginFlowAllowableValues();
        if (!is_null($this->container['login_flow']) && !in_array($this->container['login_flow'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'login_flow', must be one of '%s'",
                $this->container['login_flow'],
                implode("', '", $allowedValues)
            );
        }

        if ($this->container['login_flow_options'] === null) {
            $invalidProperties[] = "'login_flow_options' can't be null";
        }
    ...
    public function setProductKey($product_key)
    {
        if (is_null($product_key)) {
            throw new \InvalidArgumentException('non-nullable product_key cannot be null');
        }
     ...
     *
     * @param string $external_application_protocol_version external_application_protocol_version
     *
     * @return self
     */
     ...
     *
     * @param string $webhook_username webhook_username
     *
     * @return self
     */
     ...
     *
     * @param string $webhook_password webhook_password
     *
     * @return self
     */
     ...
     *
     * @param string $webhook_test_invalid_username webhook_test_invalid_username
     *
     * @return self
     */
     ...
     *
     * @param string $webhook_test_valid_username webhook_test_valid_username
     *
     * @return self
     */
     ...
     *
     * @param string $webhook_test_valid_password webhook_test_valid_password
     *
     * @return self
     */
     ...
     *
     * @param string $external_application_username external_application_username
     *
     * @return self
     */
     ...
     *
     * @param string $legacy_auth_methods_url legacy_auth_methods_url
     *
     * @return self
     */
     ...
     *
     * @param string $password_verify_url password_verify_url
     *
     * @return self
     */
     ...
     *
     * @param string $auth_success_redirect_url auth_success_redirect_url
     *
     * @return self
     */
     ...
     *
     * @param string $password_reset_url password_reset_url
     *
     * @return self
     */
     ...
     *
     * @param bool $allow_user_registration allow_user_registration
     *
     * @return self
     */
     ...
     *
     * @param bool $allow_ip_stickiness allow_ip_stickiness
     *
     * @return self
     */
     ...
     *
     * @param string $passkey_append_interval passkey_append_interval
     *
     * @return self
     */
     ...
     * Sets cli_secret
     *
     * @param string $cli_secret cli_secret
     *
     * @return self
     */
    ...
    /**
     * Gets has_started_using_sessions
     *
     * @return bool
     */
    public function getHasStartedUsingSessions()
    {
        return $this->container['has_started_using_sessions'];
    }

    /**
     * Sets has_started_using_sessions
     *
     * @param bool $has_started_using_sessions has_started_using_sessions
     *
     * @return self
     */
    public function setHasStartedUsingSessions($has_started_using_sessions)
    {
        if (is_null($has_started_using_sessions)) {
            throw new \InvalidArgumentException('non-nullable has_started_using_sessions cannot be null');
        }
        $this->container['has_started_using_sessions'] = $has_started_using_sessions;
    ...
    /**
     * Gets frontend_framework
     *
     * @return string
     */
    public function getFrontendFramework()
    {
        return $this->container['frontend_framework'];
    }

    /**
     * Sets frontend_framework
     *
     * @param string $frontend_framework frontend_framework
     *
     * @return self
     */
    public function setFrontendFramework($frontend_framework)
    {
        if (is_null($frontend_framework)) {
            throw new \InvalidArgumentException('non-nullable frontend_framework cannot be null');
        }
        $allowedValues = $this->getFrontendFrameworkAllowableValues();
        if (!in_array($frontend_framework, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'frontend_framework', must be one of '%s'",
                    $frontend_framework,
        ...
        $this->container['frontend_framework'] = $frontend_framework;

        return $this;
    }

    /**
     * Gets backend_language
     *
     * @return string
     */
    public function getBackendLanguage()
    {
        return $this->container['backend_language'];
    }

    /**
     * Sets backend_language
     *
     * @param string $backend_language backend_language
     *
     * @return self
     */
    public function setBackendLanguage($backend_language)
    {
        if (is_null($backend_language)) {
            throw new \InvalidArgumentException('non-nullable backend_language cannot be null');
        }
        $allowedValues = $this->getBackendLanguageAllowableValues();
        if (!in_array($backend_language, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'backend_language', must be one of '%s'",
                    $backend_language,
        ...
        $this->container['backend_language'] = $backend_language;
    ...
    /**
     * Gets webhook_actions
     *
     * @return string[]
     */
    public function getWebhookActions()
    {
        return $this->container['webhook_actions'];
    }

    /**
     * Sets webhook_actions
     *
     * @param string[] $webhook_actions webhook_actions
     *
     * @return self
     */
    public function setWebhookActions($webhook_actions)
    {
        if (is_null($webhook_actions)) {
            throw new \InvalidArgumentException('non-nullable webhook_actions cannot be null');
        }
        $this->container['webhook_actions'] = $webhook_actions;
     ...
     * @return string
     */
    public function getSignupFlow()
    {
        return $this->container['signup_flow'];
    }

    /**
     * Sets signup_flow
     *
     * @param string $signup_flow signup_flow
     *
     * @return self
     */
    public function setSignupFlow($signup_flow)
    {
        if (is_null($signup_flow)) {
            throw new \InvalidArgumentException('non-nullable signup_flow cannot be null');
        }
        $allowedValues = $this->getSignupFlowAllowableValues();
        if (!in_array($signup_flow, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'signup_flow', must be one of '%s'",
                    $signup_flow,
        ...
        $this->container['signup_flow'] = $signup_flow;

        return $this;
    }

    /**
     * Gets signup_flow_options
     *
     * @return object
     */
    public function getSignupFlowOptions()
    {
        return $this->container['signup_flow_options'];
    }

    /**
     * Sets signup_flow_options
     *
     * @param object $signup_flow_options signup_flow_options
     *
     * @return self
     */
    public function setSignupFlowOptions($signup_flow_options)
    {
        if (is_null($signup_flow_options)) {
            throw new \InvalidArgumentException('non-nullable signup_flow_options cannot be null');
        }
        $this->container['signup_flow_options'] = $signup_flow_options;
     ...
     * @return string
     */
    public function getLoginFlow()
    {
        return $this->container['login_flow'];
    }

    /**
     * Sets login_flow
     *
     * @param string $login_flow login_flow
     *
     * @return self
     */
    public function setLoginFlow($login_flow)
    {
        if (is_null($login_flow)) {
            throw new \InvalidArgumentException('non-nullable login_flow cannot be null');
        }
        $allowedValues = $this->getLoginFlowAllowableValues();
        if (!in_array($login_flow, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'login_flow', must be one of '%s'",
                    $login_flow,
        ...
        $this->container['login_flow'] = $login_flow;

        return $this;
    }

    /**
     * Gets login_flow_options
     *
     * @return object
     */
    public function getLoginFlowOptions()
    {
        return $this->container['login_flow_options'];
    }

    /**
     * Sets login_flow_options
     *
     * @param object $login_flow_options login_flow_options
     *
     * @return self
     */
    public function setLoginFlowOptions($login_flow_options)
    {
        if (is_null($login_flow_options)) {
            throw new \InvalidArgumentException('non-nullable login_flow_options cannot be null');
        }
        $this->container['login_flow_options'] = $login_flow_options;
