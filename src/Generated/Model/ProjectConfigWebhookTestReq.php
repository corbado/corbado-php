...
/**
 * ProjectConfigWebhookTestReq Class Doc Comment
 *
 * @category Class
 * @package  Corbado\Generated
 * @author   OpenAPI Generator team
 ...
 */
class ProjectConfigWebhookTestReq implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'projectConfigWebhookTestReq';
    ...
    public const ACTION_AUTH_METHODS = 'authMethods';
    public const ACTION_PASSWORD_VERIFY = 'passwordVerify';
    ...
    {
        return [
            self::ACTION_AUTH_METHODS,
            self::ACTION_PASSWORD_VERIFY,
        ];
    }
