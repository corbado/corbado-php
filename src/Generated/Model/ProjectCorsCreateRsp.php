...
/**
 * ProjectCorsCreateRsp Class Doc Comment
 *
 * @category Class
 * @package  Corbado\Generated
 * @author   OpenAPI Generator team
 ...
 */
class ProjectCorsCreateRsp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'projectCorsCreateRsp';
    ...
    public function setHttpStatusCode($http_status_code)
    {
        ...
        if (($http_status_code > 599)) {
            throw new \InvalidArgumentException('invalid value for $http_status_code when calling ProjectCorsCreateRsp., must be smaller than or equal to 599.');
        }
        if (($http_status_code < 200)) {
            throw new \InvalidArgumentException('invalid value for $http_status_code when calling ProjectCorsCreateRsp., must be bigger than or equal to 200.');
        }
     ...
     * Sets id
     *
     * @param string $id ID of project CORS
     *
     * @return self
     */
     ...
     * Sets domain
     *
     * @param string $domain CORS domain to be included to project
     *
     * @return self
     */
