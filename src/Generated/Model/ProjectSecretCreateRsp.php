...
/**
 * ProjectSecretCreateRsp Class Doc Comment
 *
 * @category Class
 * @package  Corbado\Generated
 * @author   OpenAPI Generator team
 ...
 */
class ProjectSecretCreateRsp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'projectSecretCreateRsp';
    ...
    */
    ...
    public function setHttpStatusCode($http_status_code)
    {
        ...
        if (($http_status_code > 599)) {
            throw new \InvalidArgumentException('invalid value for $http_status_code when calling ProjectSecretCreateRsp., must be smaller than or equal to 599.');
        }
        if (($http_status_code < 200)) {
            throw new \InvalidArgumentException('invalid value for $http_status_code when calling ProjectSecretCreateRsp., must be bigger than or equal to 200.');
        }
     ...
     * Sets id
     *
     * @param string $id ID of project secret
     *
     * @return self
     */
     ...
     * Sets secret
     *
     * @param string|null $secret Server-side generated secret. Only filled on create
     *
     * @return self
     */
     ...
     * Sets hint
     *
     * @param string $hint Hint of the server-side generated secret. First 3 characters and last 3 characters
     *
     * @return self
     */
