 ...
 */
class RequestData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'requestData';
    ...
    */
     ...
     * Sets link
     *
     * @param string $link Link to dashboard with details about request
     *
     * @return self
     */
