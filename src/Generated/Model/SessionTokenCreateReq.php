 ...
 */
class SessionTokenCreateReq implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'sessionTokenCreateReq';
    ...
    */
     ...
     * Sets user_data
     *
     * @param string $user_data Additional user data in JSON format
     *
     * @return self
     */
