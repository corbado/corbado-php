...
/**
 * SmsCodeSendReq Class Doc Comment
 *
 * @category Class
 * @package  Corbado\Generated
 * @author   OpenAPI Generator team
 ...
 */
class SmsCodeSendReq implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'smsCodeSendReq';
     ...
     * Sets create
     *
     * @param bool $create Defines if user phone number should be created if not found
     *
     * @return self
     */
     ...
     * Sets template_name
     *
     * @param string|null $template_name Template name of SMS to send
     *
     * @return self
     */
