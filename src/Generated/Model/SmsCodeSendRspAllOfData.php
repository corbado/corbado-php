...
/**
 * SmsCodeSendRspAllOfData Class Doc Comment
 *
 * @category Class
 * @package  Corbado\Generated
 * @author   OpenAPI Generator team
 ...
 */
class SmsCodeSendRspAllOfData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'smsCodeSendRsp_allOf_data';
    ...
    {
        $this->setIfExists('sms_code_id', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sms_code_id'] === null) {
            $invalidProperties[] = "'sms_code_id' can't be null";
        }
     ...
     * @return string
     */
    public function getSmsCodeId()
    {
        return $this->container['sms_code_id'];
    }

    /**
     * Sets sms_code_id
     *
     * @param string $sms_code_id sms_code_id
     *
     * @return self
     */
    public function setSmsCodeId($sms_code_id)
    {
        if (is_null($sms_code_id)) {
            throw new \InvalidArgumentException('non-nullable sms_code_id cannot be null');
        }
        $this->container['sms_code_id'] = $sms_code_id;
