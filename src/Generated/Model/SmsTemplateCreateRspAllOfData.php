...
/**
 * SmsTemplateCreateRspAllOfData Class Doc Comment
 *
 * @category Class
 * @package  Corbado\Generated
 * @author   OpenAPI Generator team
 ...
 */
class SmsTemplateCreateRspAllOfData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'smsTemplateCreateRsp_allOf_data';
    ...
    {
        $this->setIfExists('sms_template_id', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sms_template_id'] === null) {
            $invalidProperties[] = "'sms_template_id' can't be null";
        }
    ...
    {
        if (is_null($sms_template_id)) {
            throw new \InvalidArgumentException('non-nullable sms_template_id cannot be null');
        }
