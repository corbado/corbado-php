...
/**
 * TrackingBackupState Class Doc Comment
 *
 * @category Class
 * @package  Corbado\Generated
 * @author   OpenAPI Generator team
 ...
 */
class TrackingBackupState implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackingBackupState';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('not_backed_up', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['backed_up'] === null) {
            $invalidProperties[] = "'backed_up' can't be null";
        }
        if ($this->container['not_backed_up'] === null) {
            $invalidProperties[] = "'not_backed_up' can't be null";
        }
     ...
     * Sets not_backed_up
     *
     * @param int $not_backed_up not_backed_up
     *
     * @return self
     */
    public function setNotBackedUp($not_backed_up)
    {
        if (is_null($not_backed_up)) {
            throw new \InvalidArgumentException('non-nullable not_backed_up cannot be null');
        }
        $this->container['not_backed_up'] = $not_backed_up;
