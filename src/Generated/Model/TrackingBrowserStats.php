...
/**
 * TrackingBrowserStats Class Doc Comment
 *
 * @category Class
 * @package  Corbado\Generated
 * @author   OpenAPI Generator team
 ...
 */
class TrackingBrowserStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackingBrowserStats';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('chrome', $data ?? [], null);
        $this->setIfExists('safari', $data ?? [], null);
        $this->setIfExists('edge', $data ?? [], null);
        $this->setIfExists('firefox', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['chrome'] === null) {
            $invalidProperties[] = "'chrome' can't be null";
        }
        if ($this->container['safari'] === null) {
            $invalidProperties[] = "'safari' can't be null";
        }
        if ($this->container['edge'] === null) {
            $invalidProperties[] = "'edge' can't be null";
        }
        if ($this->container['firefox'] === null) {
            $invalidProperties[] = "'firefox' can't be null";
        }
    ...
    {
        return $this->container['chrome'];
    }

    /**
     * Sets chrome
     *
     * @param int $chrome chrome
     *
     * @return self
     */
    ...
    {
        if (is_null($chrome)) {
            throw new \InvalidArgumentException('non-nullable chrome cannot be null');
        }
        $this->container['chrome'] = $chrome;
    ...
    {
        return $this->container['safari'];
    }

    /**
     * Sets safari
     *
     * @param int $safari safari
     *
     * @return self
     */
    ...
    {
        if (is_null($safari)) {
            throw new \InvalidArgumentException('non-nullable safari cannot be null');
        }
        $this->container['safari'] = $safari;
    ...
    {
        return $this->container['firefox'];
    }

    /**
     * Sets firefox
     *
     * @param int $firefox firefox
     *
     * @return self
     */
    ...
    {
        if (is_null($firefox)) {
            throw new \InvalidArgumentException('non-nullable firefox cannot be null');
        }
        $this->container['firefox'] = $firefox;
