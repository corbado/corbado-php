...
class TrackingBrowserStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['chrome'] = $data['chrome'] ?? null;
        $this->container['safari'] = $data['safari'] ?? null;
        $this->container['edge'] = $data['edge'] ?? null;
        $this->container['firefox'] = $data['firefox'] ?? null;
