...
/**
 * TrackingEnums Class Doc Comment
 *
 * @category Class
 * @package  Corbado\Generated
 * @author   OpenAPI Generator team
 ...
 */
class TrackingEnums implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackingEnums';
    ...
    protected static $attributeMap = [
        'browser_names' => 'browserNames',
        'os_names' => 'osNames',
        'os_platforms' => 'osPlatforms'
    ];
    ...
    protected static $setters = [
        'browser_names' => 'setBrowserNames',
        'os_names' => 'setOsNames',
        'os_platforms' => 'setOsPlatforms'
    ];
    ...
    protected static $getters = [
        'browser_names' => 'getBrowserNames',
        'os_names' => 'getOsNames',
        'os_platforms' => 'getOsPlatforms'
    ];
    ...
    {
        $this->setIfExists('browser_names', $data ?? [], null);
        $this->setIfExists('os_names', $data ?? [], null);
        $this->setIfExists('os_platforms', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['browser_names'] === null) {
            $invalidProperties[] = "'browser_names' can't be null";
        }
        if ($this->container['os_names'] === null) {
            $invalidProperties[] = "'os_names' can't be null";
        }
        if ($this->container['os_platforms'] === null) {
            $invalidProperties[] = "'os_platforms' can't be null";
        }
    ...
    {
        return $this->container['browser_names'];
    }

    /**
     * Sets browser_names
     *
     * @param string[] $browser_names browser_names
     *
     * @return self
     */
    public function setBrowserNames($browser_names)
    {
        if (is_null($browser_names)) {
            throw new \InvalidArgumentException('non-nullable browser_names cannot be null');
        }
        $this->container['browser_names'] = $browser_names;
     ...
     * Sets os_names
     *
     * @param string[] $os_names os_names
     *
     * @return self
     */
    ...
    {
        return $this->container['os_platforms'];
    }

    /**
     * Sets os_platforms
     *
     * @param string[] $os_platforms os_platforms
     *
     * @return self
     */
    public function setOsPlatforms($os_platforms)
    {
        if (is_null($os_platforms)) {
            throw new \InvalidArgumentException('non-nullable os_platforms cannot be null');
        }
        $this->container['os_platforms'] = $os_platforms;
