...
/**
 * TrackingOSDetailedStats Class Doc Comment
 *
 * @category Class
 * @package  Corbado\Generated
 * @author   OpenAPI Generator team
 ...
 */
class TrackingOSDetailedStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackingOSDetailedStats';
    ...
    protected static $setters = [
        ...
        'conditional_ui' => 'setConditionalUi'
    ];
    ...
    protected static $getters = [
        ...
        'conditional_ui' => 'getConditionalUi'
    ];
    ...
    public const OS_PLATFORM_DESKTOP = 'desktop';
    public const OS_PLATFORM_MOBILE = 'mobile';
    public const OS_PLATFORM_UNKNOWN = 'unknown';
     ...
     * @return string[]
     */
    public function getOsPlatformAllowableValues()
    {
        return [
            self::OS_PLATFORM_DESKTOP,
            self::OS_PLATFORM_MOBILE,
            self::OS_PLATFORM_UNKNOWN,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('conditional_ui', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['os_platform'] === null) {
            $invalidProperties[] = "'os_platform' can't be null";
        }
        $allowedValues = $this->getOsPlatformAllowableValues();
        if (!is_null($this->container['os_platform']) && !in_array($this->container['os_platform'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'os_platform', must be one of '%s'",
                $this->container['os_platform'],
        ...
        if ($this->container['conditional_ui'] === null) {
            $invalidProperties[] = "'conditional_ui' can't be null";
        }
    ...
    public function setOsPlatform($os_platform)
    {
        if (is_null($os_platform)) {
            throw new \InvalidArgumentException('non-nullable os_platform cannot be null');
        }
        $allowedValues = $this->getOsPlatformAllowableValues();
        if (!in_array($os_platform, $allowedValues, true)) {
     ...
     * @return int
     */
    public function getConditionalUi()
    {
        return $this->container['conditional_ui'];
    }

    /**
     * Sets conditional_ui
     *
     * @param int $conditional_ui conditional_ui
     *
     * @return self
     */
    public function setConditionalUi($conditional_ui)
    {
        if (is_null($conditional_ui)) {
            throw new \InvalidArgumentException('non-nullable conditional_ui cannot be null');
        }
        $this->container['conditional_ui'] = $conditional_ui;
