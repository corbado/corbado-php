...
/**
 * TrackingOSStats Class Doc Comment
 *
 * @category Class
 * @package  Corbado\Generated
 * @author   OpenAPI Generator team
 ...
 */
class TrackingOSStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackingOSStats';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('ios', $data ?? [], null);
        $this->setIfExists('android', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['macos'] === null) {
            $invalidProperties[] = "'macos' can't be null";
        }
        if ($this->container['windows'] === null) {
            $invalidProperties[] = "'windows' can't be null";
        }
    ...
    {
        if (is_null($ios)) {
            throw new \InvalidArgumentException('non-nullable ios cannot be null');
        }
    ...
    {
        if (is_null($android)) {
            throw new \InvalidArgumentException('non-nullable android cannot be null');
        }
