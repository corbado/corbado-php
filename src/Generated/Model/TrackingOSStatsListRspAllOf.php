 ...
 */
class TrackingOSStatsListRspAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackingOSStatsListRsp_allOf';
