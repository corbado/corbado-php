...
/**
 * TrackingOsListRsp Class Doc Comment
 *
 * @category Class
 * @package  Corbado\Generated
 * @author   OpenAPI Generator team
 ...
 */
class TrackingOsListRsp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackingOsListRsp';
    ...
    protected static $openAPITypes = [
        ...
        'runtime' => 'float',
        'rows' => '\Corbado\Generated\Model\TrackingOsListItem[]',
    ...
    public function setHttpStatusCode($http_status_code)
    {
        ...
        if (($http_status_code > 599)) {
            throw new \InvalidArgumentException('invalid value for $http_status_code when calling TrackingOsListRsp., must be smaller than or equal to 599.');
        }
        if (($http_status_code < 200)) {
            throw new \InvalidArgumentException('invalid value for $http_status_code when calling TrackingOsListRsp., must be bigger than or equal to 200.');
        }
     ...
     * Gets rows
     *
     * @return \Corbado\Generated\Model\TrackingOsListItem[]
     */
     ...
     * Sets rows
     *
     * @param \Corbado\Generated\Model\TrackingOsListItem[] $rows rows
     *
     * @return self
     */
