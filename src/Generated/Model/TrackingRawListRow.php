...
class TrackingRawListRow implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('has_webauthn', $data ?? [], null);
        $this->setIfExists('has_platform_auth', $data ?? [], null);
        $this->setIfExists('has_conditional_ui', $data ?? [], null);
        $this->setIfExists('os_id', $data ?? [], null);
        $this->setIfExists('browser_id', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($has_webauthn)) {
            throw new \InvalidArgumentException('non-nullable has_webauthn cannot be null');
        }
    ...
    {
        if (is_null($has_platform_auth)) {
            throw new \InvalidArgumentException('non-nullable has_platform_auth cannot be null');
        }
    ...
    {
        if (is_null($has_conditional_ui)) {
            throw new \InvalidArgumentException('non-nullable has_conditional_ui cannot be null');
        }
    ...
    public function setBrowserId($browser_id)
    {
        if (is_null($browser_id)) {
            throw new \InvalidArgumentException('non-nullable browser_id cannot be null');
        }
