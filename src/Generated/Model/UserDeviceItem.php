...
/**
 * UserDeviceItem Class Doc Comment
 *
 * @category Class
 * @package  CorbadoGenerated
 * @author   OpenAPI Generator team
 ...
 */
class UserDeviceItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userDeviceItem';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('can_pass_keys', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['can_pass_keys'] === null) {
            $invalidProperties[] = "'can_pass_keys' can't be null";
        }
     ...
     * @return bool
     */
    public function getCanPassKeys()
    {
        return $this->container['can_pass_keys'];
    }

    /**
     * Sets can_pass_keys
     *
     * @param bool $can_pass_keys can_pass_keys
     *
     * @return self
     */
    public function setCanPassKeys($can_pass_keys)
    {
        if (is_null($can_pass_keys)) {
            throw new \InvalidArgumentException('non-nullable can_pass_keys cannot be null');
        }
        $this->container['can_pass_keys'] = $can_pass_keys;
