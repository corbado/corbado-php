...
class UserDeviceListRsp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userDeviceListRsp';
    ...
    protected static $openAPITypes = [
        ...
        'runtime' => 'float',
        'devices' => '\Corbado\Generated\Model\UserDevice[]',
    ...
    */
    ...
    public function setHttpStatusCode($http_status_code)
    {
        ...
        if (($http_status_code < 200)) {
            throw new \InvalidArgumentException('invalid value for $http_status_code when calling UserDeviceListRsp., must be bigger than or equal to 200.');
        }
     ...
     * Gets devices
     *
     * @return \Corbado\Generated\Model\UserDevice[]
     */
     ...
     * Sets devices
     *
     * @param \Corbado\Generated\Model\UserDevice[] $devices devices
     *
     * @return self
     */
