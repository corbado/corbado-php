 ...
 */
class UserDeviceListRspAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userDeviceListRsp_allOf';
