...
/**
 * UserEmailDeleteReq Class Doc Comment
 *
 * @category Class
 * @package  CorbadoGenerated
 * @author   OpenAPI Generator team
 ...
 */
class UserEmailDeleteReq implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userEmailDeleteReq';
