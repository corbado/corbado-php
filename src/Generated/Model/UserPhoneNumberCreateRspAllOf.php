 ...
 */
class UserPhoneNumberCreateRspAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userPhoneNumberCreateRsp_allOf';
