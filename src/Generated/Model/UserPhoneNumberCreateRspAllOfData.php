...
/**
 * UserPhoneNumberCreateRspAllOfData Class Doc Comment
 *
 * @category Class
 * @package  CorbadoGenerated
 * @author   OpenAPI Generator team
 ...
 */
class UserPhoneNumberCreateRspAllOfData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userPhoneNumberCreateRsp_allOf_data';
