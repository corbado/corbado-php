...
class UserStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['total_users'] = $data['total_users'] ?? null;
        $this->container['sign_ups'] = $data['sign_ups'] ?? null;
        $this->container['active_users'] = $data['active_users'] ?? null;
        $this->container['count_passkey_login'] = $data['count_passkey_login'] ?? null;
        $this->container['count_email_login'] = $data['count_email_login'] ?? null;
        $this->container['count_password_login'] = $data['count_password_login'] ?? null;
        $this->container['successful_logins'] = $data['successful_logins'] ?? null;
        $this->container['failed_logins'] = $data['failed_logins'] ?? null;
    }
