...
/**
 * UserStatsListRsp Class Doc Comment
 *
 * @category Class
 * @package  Corbado\Generated
 * @author   OpenAPI Generator team
 ...
 */
class UserStatsListRsp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userStatsListRsp';
    ...
    protected static $openAPITypes = [
        ...
        'runtime' => 'float',
        'data' => '\Corbado\Generated\Model\UserStatsListRspAllOfData'
    ];
    ...
    */
    ...
    public function setHttpStatusCode($http_status_code)
    {
        ...
        if (($http_status_code > 599)) {
            throw new \InvalidArgumentException('invalid value for $http_status_code when calling UserStatsListRsp., must be smaller than or equal to 599.');
        }
        if (($http_status_code < 200)) {
            throw new \InvalidArgumentException('invalid value for $http_status_code when calling UserStatsListRsp., must be bigger than or equal to 200.');
        }
     ...
     * Gets data
     *
     * @return \Corbado\Generated\Model\UserStatsListRspAllOfData
     */
     ...
     * Sets data
     *
     * @param \Corbado\Generated\Model\UserStatsListRspAllOfData $data data
     *
     * @return self
     */
