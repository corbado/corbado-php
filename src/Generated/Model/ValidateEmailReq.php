...
/**
 * ValidateEmailReq Class Doc Comment
 *
 * @category Class
 * @package  Corbado\Generated
 * @author   OpenAPI Generator team
 ...
 */
class ValidateEmailReq implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'validateEmailReq';
    ...
    protected static $setters = [
        ...
        'suggest_domain' => 'setSuggestDomain',
    ...
    protected static $getters = [
        ...
        'suggest_domain' => 'getSuggestDomain',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('suggest_domain', $data ?? [], null);
    ...
    */
     ...
     * Sets smtp_check
     *
     * @param bool|null $smtp_check perform SMTP check for domain
     *
     * @return self
     */
     ...
     * @return bool|null
     */
    public function getSuggestDomain()
    {
        return $this->container['suggest_domain'];
    }

    /**
     * Sets suggest_domain
     *
     * @param bool|null $suggest_domain enables domain suggestion for misspelled domains
     *
     * @return self
     */
    public function setSuggestDomain($suggest_domain)
    {
        if (is_null($suggest_domain)) {
            throw new \InvalidArgumentException('non-nullable suggest_domain cannot be null');
        }
        $this->container['suggest_domain'] = $suggest_domain;
