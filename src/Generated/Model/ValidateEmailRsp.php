...
/**
 * ValidateEmailRsp Class Doc Comment
 *
 * @category Class
 * @package  Corbado\Generated
 * @author   OpenAPI Generator team
 ...
 */
class ValidateEmailRsp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'validateEmailRsp';
    ...
    protected static $openAPITypes = [
        ...
        'runtime' => 'float',
        'data' => '\Corbado\Generated\Model\EmailValidationResult'
    ];
    ...
    */
    ...
    public function setHttpStatusCode($http_status_code)
    {
        ...
        if (($http_status_code > 599)) {
            throw new \InvalidArgumentException('invalid value for $http_status_code when calling ValidateEmailRsp., must be smaller than or equal to 599.');
        }
        if (($http_status_code < 200)) {
            throw new \InvalidArgumentException('invalid value for $http_status_code when calling ValidateEmailRsp., must be bigger than or equal to 200.');
        }
     ...
     * Gets data
     *
     * @return \Corbado\Generated\Model\EmailValidationResult
     */
     ...
     * Sets data
     *
     * @param \Corbado\Generated\Model\EmailValidationResult $data data
     *
     * @return self
     */
