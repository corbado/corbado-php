...
/**
 * ValidationPhoneNumber Class Doc Comment
 *
 * @category Class
 * @package  Corbado\Generated
 * @author   OpenAPI Generator team
 ...
 */
class ValidationPhoneNumber implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'validationPhoneNumber';
    ...
    protected static $openAPIFormats = [
        ...
        'country_code' => null,
        'region_code' => null,
        'national_formatted' => null,
        'international_formatted' => null
    ];
    ...
    protected static array $openAPINullables = [
		...
		'country_code' => false,
		'region_code' => false,
		'national_formatted' => false,
		'international_formatted' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'national_formatted' => 'nationalFormatted',
        'international_formatted' => 'internationalFormatted'
    ];
    ...
    protected static $setters = [
        ...
        'national_formatted' => 'setNationalFormatted',
        'international_formatted' => 'setInternationalFormatted'
    ];
    ...
    protected static $getters = [
        ...
        'national_formatted' => 'getNationalFormatted',
        'international_formatted' => 'getInternationalFormatted'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('national_formatted', $data ?? [], null);
        $this->setIfExists('international_formatted', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['national_formatted'] === null) {
            $invalidProperties[] = "'national_formatted' can't be null";
        }
        if ($this->container['international_formatted'] === null) {
            $invalidProperties[] = "'international_formatted' can't be null";
        }
     ...
     *
     * @param int $national_number national_number
     *
     * @return self
     */
    ...
    /**
     * Gets national_formatted
     *
     * @return string
     */
    public function getNationalFormatted()
    {
        return $this->container['national_formatted'];
    }

    /**
     * Sets national_formatted
     *
     * @param string $national_formatted national_formatted
     *
     * @return self
     */
    public function setNationalFormatted($national_formatted)
    {
        if (is_null($national_formatted)) {
            throw new \InvalidArgumentException('non-nullable national_formatted cannot be null');
        }
        $this->container['national_formatted'] = $national_formatted;

        return $this;
    }

    /**
     * Gets international_formatted
     *
     * @return string
     */
    public function getInternationalFormatted()
    {
        return $this->container['international_formatted'];
    }

    /**
     * Sets international_formatted
     *
     * @param string $international_formatted international_formatted
     *
     * @return self
     */
    public function setInternationalFormatted($international_formatted)
    {
        if (is_null($international_formatted)) {
            throw new \InvalidArgumentException('non-nullable international_formatted cannot be null');
        }
        $this->container['international_formatted'] = $international_formatted;
