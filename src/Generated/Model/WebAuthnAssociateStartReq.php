...
/**
 * WebAuthnAssociateStartReq Class Doc Comment
 *
 * @category Class
 * @package  Corbado\Generated
 * @author   OpenAPI Generator team
 ...
 */
class WebAuthnAssociateStartReq implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'webAuthnAssociateStartReq';
    ...
    protected static $setters = [
        'association_token' => 'setAssociationToken',
    ...
    protected static $getters = [
        'association_token' => 'getAssociationToken',
    ...
    {
        $this->setIfExists('association_token', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['association_token'] === null) {
            $invalidProperties[] = "'association_token' can't be null";
        }
    ...
    /**
     * Gets association_token
     *
     * @return string
     */
    public function getAssociationToken()
    {
        return $this->container['association_token'];
    }

    /**
     * Sets association_token
     *
     * @param string $association_token association_token
     *
     * @return self
     */
    public function setAssociationToken($association_token)
    {
        if (is_null($association_token)) {
            throw new \InvalidArgumentException('non-nullable association_token cannot be null');
        }
        $this->container['association_token'] = $association_token;
