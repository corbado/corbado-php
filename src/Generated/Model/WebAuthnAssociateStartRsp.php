...
/**
 * WebAuthnAssociateStartRsp Class Doc Comment
 *
 * @category Class
 * @package  Corbado\Generated
 * @author   OpenAPI Generator team
 ...
 */
class WebAuthnAssociateStartRsp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'webAuthnAssociateStartRsp';
    ...
    protected static $openAPIFormats = [
        ...
        'runtime' => 'float',
        'status' => null,
        'public_key_credential_creation_options' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'runtime' => false,
        'status' => false,
        'public_key_credential_creation_options' => false
    ];
    ...
    protected static $setters = [
        ...
        'runtime' => 'setRuntime',
        'status' => 'setStatus',
        'public_key_credential_creation_options' => 'setPublicKeyCredentialCreationOptions'
    ];
    ...
    protected static $getters = [
        ...
        'runtime' => 'getRuntime',
        'status' => 'getStatus',
        'public_key_credential_creation_options' => 'getPublicKeyCredentialCreationOptions'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('public_key_credential_creation_options', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['public_key_credential_creation_options'] === null) {
            $invalidProperties[] = "'public_key_credential_creation_options' can't be null";
        }
    ...
    public function setHttpStatusCode($http_status_code)
    {
        ...
        if (($http_status_code > 599)) {
            throw new \InvalidArgumentException('invalid value for $http_status_code when calling WebAuthnAssociateStartRsp., must be smaller than or equal to 599.');
        }
        if (($http_status_code < 200)) {
            throw new \InvalidArgumentException('invalid value for $http_status_code when calling WebAuthnAssociateStartRsp., must be bigger than or equal to 200.');
        }
     ...
     * Sets status
     *
     * @param string $status Status represents information if user signup was successful or the user with its credentials already exists
     *
     * @return self
     */
    ...
    /**
     * Gets public_key_credential_creation_options
     *
     * @return string
     */
    public function getPublicKeyCredentialCreationOptions()
    {
        return $this->container['public_key_credential_creation_options'];
    }

    /**
     * Sets public_key_credential_creation_options
     *
     * @param string $public_key_credential_creation_options Contains JSON payload data to start Passkeys (Biometrics) sign up challenge
     *
     * @return self
     */
    public function setPublicKeyCredentialCreationOptions($public_key_credential_creation_options)
    {
        if (is_null($public_key_credential_creation_options)) {
            throw new \InvalidArgumentException('non-nullable public_key_credential_creation_options cannot be null');
        }
        $this->container['public_key_credential_creation_options'] = $public_key_credential_creation_options;
