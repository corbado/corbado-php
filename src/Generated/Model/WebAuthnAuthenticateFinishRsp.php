...
/**
 * WebAuthnAuthenticateFinishRsp Class Doc Comment
 *
 * @category Class
 * @package  Corbado\Generated
 * @author   OpenAPI Generator team
 ...
 */
class WebAuthnAuthenticateFinishRsp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'webAuthnAuthenticateFinishRsp';
    ...
    const STATUS_UNCONFIRMED_CREDENTIAL = 'unconfirmedCredential';
    ...
    public function getStatusAllowableValues()
    {
        return [
            self::STATUS_SUCCESS,
            self::STATUS_UNCONFIRMED_CREDENTIAL,
        ];
    }
    ...
    public function setHttpStatusCode($http_status_code)
    {
        ...
        if (($http_status_code > 599)) {
            throw new \InvalidArgumentException('invalid value for $http_status_code when calling WebAuthnAuthenticateFinishRsp., must be smaller than or equal to 599.');
        }
        if (($http_status_code < 200)) {
            throw new \InvalidArgumentException('invalid value for $http_status_code when calling WebAuthnAuthenticateFinishRsp., must be bigger than or equal to 200.');
        }
     ...
     * Sets username
     *
     * @param string $username Username of current challenge
     *
     * @return self
     */
     ...
     * Sets credential_id
     *
     * @param string $credential_id Used credential ID
     *
     * @return self
     */
