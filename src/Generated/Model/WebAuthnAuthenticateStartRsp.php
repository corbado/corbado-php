...
/**
 * WebAuthnAuthenticateStartRsp Class Doc Comment
 *
 * @category Class
 * @package  Corbado\Generated
 * @author   OpenAPI Generator team
 ...
 */
class WebAuthnAuthenticateStartRsp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'webAuthnAuthenticateStartRsp';
    ...
    const STATUS_UNKNOWN_DEVICE = 'unknownDevice';
    const STATUS_UNCONFIRMED_DEVICE = 'unconfirmedDevice';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['public_key_credential_request_options'] = $data['public_key_credential_request_options'] ?? null;
    ...
    public function setHttpStatusCode($http_status_code)
    {
        ...
        if (($http_status_code > 599)) {
            throw new \InvalidArgumentException('invalid value for $http_status_code when calling WebAuthnAuthenticateStartRsp., must be smaller than or equal to 599.');
        }
        if (($http_status_code < 200)) {
            throw new \InvalidArgumentException('invalid value for $http_status_code when calling WebAuthnAuthenticateStartRsp., must be bigger than or equal to 200.');
        }
