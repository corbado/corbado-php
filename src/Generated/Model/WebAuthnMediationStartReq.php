 ...
 */
class WebAuthnMediationStartReq implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'webAuthnMediationStartReq';
    ...
    */
     ...
     * Sets username
     *
     * @param string|null $username Optional limits possible credentials matching to username
     *
     * @return self
     */
