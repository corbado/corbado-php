 ...
 */
class WebAuthnRegisterStartReq implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'webAuthnRegisterStartReq';
    ...
    const CREDENTIAL_STATUS_ACTIVE = 'active';
    const CREDENTIAL_STATUS_PENDING = 'pending';
     ...
     * @return string[]
     */
    public function getCredentialStatusAllowableValues()
    {
        return [
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['user_full_name'] = $data['user_full_name'] ?? null;
        $this->container['request_id'] = $data['request_id'] ?? null;
        $this->container['client_info'] = $data['client_info'] ?? null;
        $this->container['credential_status'] = $data['credential_status'] ?? 'pending';
    }
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getCredentialStatusAllowableValues();
        if (!is_null($this->container['credential_status']) && !in_array($this->container['credential_status'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'credential_status', must be one of '%s'",
                $this->container['credential_status'],
     ...
     *
     * @param string|null $credential_status Sets credential status into active and pending. Pending status dont allow a login until the credential gets confirmed by an api call.
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getCredentialStatusAllowableValues();
        if (!is_null($credential_status) && !in_array($credential_status, $allowedValues, true)) {
