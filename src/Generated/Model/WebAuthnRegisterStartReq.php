...
class WebAuthnRegisterStartReq implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const CREDENTIAL_STATUS_ACTIVE = 'active';
    public const CREDENTIAL_STATUS_PENDING = 'pending';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('credential_status', $data ?? [], 'pending');
    }
    ...
    */
    ...
    public function setCredentialStatus($credential_status)
    {
        ...
        $allowedValues = $this->getCredentialStatusAllowableValues();
        if (!in_array($credential_status, $allowedValues, true)) {
