...
/**
 * WebauthnSettingListRsp Class Doc Comment
 *
 * @category Class
 * @package  Corbado\Generated
 * @author   OpenAPI Generator team
 ...
 */
class WebauthnSettingListRsp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'webauthnSettingListRsp';
    ...
    protected static $openAPITypes = [
        ...
        'runtime' => 'float',
        'rows' => '\Corbado\Generated\Model\WebauthnSettingItem[]',
    ...
    */
    ...
    public function setHttpStatusCode($http_status_code)
    {
        ...
        if (($http_status_code > 599)) {
            throw new \InvalidArgumentException('invalid value for $http_status_code when calling WebauthnSettingListRsp., must be smaller than or equal to 599.');
        }
        if (($http_status_code < 200)) {
            throw new \InvalidArgumentException('invalid value for $http_status_code when calling WebauthnSettingListRsp., must be bigger than or equal to 200.');
        }
     ...
     * Gets rows
     *
     * @return \Corbado\Generated\Model\WebauthnSettingItem[]
     */
     ...
     * Sets rows
     *
     * @param \Corbado\Generated\Model\WebauthnSettingItem[] $rows rows
     *
     * @return self
     */
