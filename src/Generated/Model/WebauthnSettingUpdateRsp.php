...
/**
 * WebauthnSettingUpdateRsp Class Doc Comment
 *
 * @category Class
 * @package  Corbado\Generated
 * @author   OpenAPI Generator team
 ...
 */
class WebauthnSettingUpdateRsp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'webauthnSettingUpdateRsp';
    ...
    */
    ...
    public function setHttpStatusCode($http_status_code)
    {
        ...
        if (($http_status_code > 599)) {
            throw new \InvalidArgumentException('invalid value for $http_status_code when calling WebauthnSettingUpdateRsp., must be smaller than or equal to 599.');
        }
        if (($http_status_code < 200)) {
            throw new \InvalidArgumentException('invalid value for $http_status_code when calling WebauthnSettingUpdateRsp., must be bigger than or equal to 200.');
        }
     ...
     * Sets name
     *
     * @param string $name Name of this setting
     *
     * @return self
     */
     ...
     * Sets origin
     *
     * @param string $origin Define here the url incl. schema, may needed subdomain and port when not 80 or 443 of your app
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string $id ID of WebAuthn setting
     *
     * @return self
     */
