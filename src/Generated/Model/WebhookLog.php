...
class WebhookLog implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'response_error' => 'setResponseError',
        'runtime' => 'setRuntime',
        'created' => 'setCreated'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['response_error'] === null) {
            $invalidProperties[] = "'response_error' can't be null";
        }
     ...
     * Sets webhook_id
     *
     * @param string $webhook_id Unique ID of webhook request which will be randomly generated on server side
     *
     * @return self
     */
     ...
     * Sets response_id
     *
     * @param string $response_id Unique ID of response, you can provide your own while responding to the webhook, if not the ID will be randomly generated on server side. This has the same meaning as overriding requestID for API requests.
     *
     * @return self
     */
     ...
     * Sets request_url
     *
     * @param string $request_url Absolute request URL of webhook backend
     *
     * @return self
     */
     ...
     * Sets request_body
     *
     * @param string $request_body Request contents that were sent to webhook backend
     *
     * @return self
     */
     ...
     *
     * @param int $response_status Response HTTP status that was returned by webhook backend
     *
     * @return self
     */
     ...
     *
     * @param object $response_headers Response HTTP headers that were returned by webhook backend
     *
     * @return self
     */
     ...
     * Sets response_body
     *
     * @param string $response_body Response body JSON data that was returned by webhook backend
     *
     * @return self
     */
    ...
    {
        return $this->container['response_error'];
    }

    /**
     * Sets response_error
     *
     * @param string $response_error Response error if present
     *
     * @return self
     */
